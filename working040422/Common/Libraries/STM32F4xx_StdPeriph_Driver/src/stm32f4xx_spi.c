...
void SPI_I2S_DeInit(SPI_TypeDef* SPIx)
{
  ...
  if (SPIx == SPI1)
  {
    ...
    RCC_APB2PeriphResetCmd(RCC_APB2Periph_SPI1, (FunctionalState)(ENABLE));
    /* Release SPI1 from reset state */
    RCC_APB2PeriphResetCmd(RCC_APB2Periph_SPI1, (FunctionalState)(DISABLE));
  }
  else if (SPIx == SPI2)
  {
    /* Enable SPI2 reset state */
    RCC_APB1PeriphResetCmd(RCC_APB1Periph_SPI2, (FunctionalState)(ENABLE));
    /* Release SPI2 from reset state */
    RCC_APB1PeriphResetCmd(RCC_APB1Periph_SPI2, (FunctionalState)(DISABLE));
  }
  else if (SPIx == SPI3)
  {
    /* Enable SPI3 reset state */
    RCC_APB1PeriphResetCmd(RCC_APB1Periph_SPI3, (FunctionalState)(ENABLE));
    /* Release SPI3 from reset state */
    RCC_APB1PeriphResetCmd(RCC_APB1Periph_SPI3, (FunctionalState)(DISABLE));
  }
  else if (SPIx == SPI4)
  {
    /* Enable SPI4 reset state */
    RCC_APB2PeriphResetCmd(RCC_APB2Periph_SPI4, (FunctionalState)(ENABLE));
    /* Release SPI4 from reset state */
    RCC_APB2PeriphResetCmd(RCC_APB2Periph_SPI4, (FunctionalState)(DISABLE));
  }
  else if (SPIx == SPI5)
  {
    /* Enable SPI5 reset state */
    RCC_APB2PeriphResetCmd(RCC_APB2Periph_SPI5, (FunctionalState)(ENABLE));
    /* Release SPI5 from reset state */
    RCC_APB2PeriphResetCmd(RCC_APB2Periph_SPI5, (FunctionalState)(DISABLE));
  }
  else 
  {
    if (SPIx == SPI6)
    {
      ...
      RCC_APB2PeriphResetCmd(RCC_APB2Periph_SPI6, (FunctionalState)(ENABLE));
      /* Release SPI6 from reset state */
      RCC_APB2PeriphResetCmd(RCC_APB2Periph_SPI6, (FunctionalState)(DISABLE));
    }
  }
}
