/**
  ...
  * @version V4.7.0RC1
  * @date    25-July-2011
  * @brief   This file contains all the common data types used by the STM32 EVAL
  *          drivers.
  ******************************************************************************
  * @attention
  *
...
#if (!defined(USE_STM320518_EVAL) && (!defined(USE_STM3210E_EVAL)))
...
#elif defined USE_STEVAL_IHM022V1
 #include "stm32f10x.h"
 #include "steval-ihm022v1.h"
 #include "steval-ihm022v1_lcd.h"
#elif defined USE_STM322xG_EVAL
 #include "stm32f2xx.h"
 #include "stm322xg_eval.h"
 #include "stm322xg_eval_lcd.h"
 #include "stm322xg_eval_ioe.h"
#elif defined USE_STM32F2XX_DUAL
 #include "stm32f2xx.h"
 #include "STM32F2xx_dual.h"
 #include "STM32F2xx_dual_lcd.h"
#elif defined USE_STM324xG_EVAL
 #include "stm324xg_eval.h"
 #include "stm324xg_eval_lcd.h"
 #include "stm324xg_eval_ioe.h"
#elif defined USE_STM32F4XX_DUAL
 #include "stm32f4xx.h"
 #include "STM32F4xx_dual.h"
 #include "STM32F4xx_dual_lcd.h"
#elif defined USE_STM320518_EVAL
 #include "stm32f0xx.h"
 #include "stm320518_eval.h"
 #include "stm320518_eval_lcd.h"
#elif defined P_NUCLEO_IHM001
 /* Include here specific files for P_NUCLEO_IHM001 if any.*/
#else 
