/**
  ******************************************************************************
  * @file    R1_F0XX_PWMnCurrFdbkPrivate.h
  * @author  STMicroelectronics - System Lab - MC Team
  * @version 4.2.0
  * @date    20-Aug-2015 18:06
  * @brief   This file contains private definition of R1_F0XX class      
  ******************************************************************************
  * @attention
  *
...
/** @defgroup R1_F0XX_Class_Private_Defines R1_F0XX private defines
* @{
*/
/** 
...
/** @defgroup R1_F0XX_private_types R1_F0XX private types
* @{
*/

/** 
  * @brief  R1_F0XX class members definition 
  */
typedef struct
{
  ...
  uint8_t bRegSmpTime[18];    
                              /*!< Array of sampling times for each channel expressed in 
                                   ADC clock cycles. E.g. 0 = 1.5 clock cycle. 
                                   See STM32F0xx reference manual for the 
                                   ramining values.*/
  uint16_t hRegConvValue[MAX_REG_CONVERSIONS];
                              /*!< Result of regular conversion.*/
  uint8_t bRegConvCh[MAX_REG_CONVERSIONS];
                              /*!< Temporary variables used to store regular 
...
/** 
  ...
  */
typedef R1_SDParams_t DParams_t, *pDParams_t; 

/** 
  * @brief Private R1_F0XX class definition 
  */
typedef struct
{
	DVars_t DVars_str;			/*!< Derived class members container */
	pDParams_t pDParams_str;	/*!< Derived class parameters container */
}_DCR1F0XX_PWMC_t, *_DCR1F0XX_PWMC;
/**
  * @}
  */
