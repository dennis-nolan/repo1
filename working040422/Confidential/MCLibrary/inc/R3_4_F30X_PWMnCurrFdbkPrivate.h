/**
  ******************************************************************************
  * @file    R3_4_F30X_PWMnCurrFdbkPrivate.h
...
#ifndef __R3_4_F30X_PWMNCURRFDBKPRIVATE_H
#define __R3_4_F30X_PWMNCURRFDBKPRIVATE_H
...
/** @defgroup R3_4_F30X_private_types R3_4_F30X private types
* @{
*/

/** 
  * @brief  R3_4_F30X class members definition 
  */
typedef struct
{
  ...
  ADC_TypeDef* ADCx_1;      /*!< First ADC used for motor phases current 
                                 measurement.*/
  ADC_TypeDef* ADCx_2;      /*!< First ADC used for motor phases current 
                                 measurement.*/
...
/** 
  ...
  */
typedef R3_4_F30XParams_t DParams_t, *pDParams_t; 

/** 
  * @brief Private R3_4_F30X class definition 
  */
typedef struct
{
   DVars_t DVars_str;		/*!< Derived class members container */
   pDParams_t pDParams_str;	/*!< Derived class parameters container */      
}_DCR3_4_F30X_PWMC_t, *_DCR3_4_F30X_PWMC;
/**
  * @}
  */
...
#endif /*__R3_4_F30X_PWMNCURRFDBKPRIVATE_H*/
