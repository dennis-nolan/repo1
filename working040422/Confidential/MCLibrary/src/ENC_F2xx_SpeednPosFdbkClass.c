/**
  ******************************************************************************
  * @file    ENC_F2xx_SpeednPosFdbkClass.c
...
#include "ENC_F2xx_SpeednPosFdbkPrivate.h"
...
static void ENC_Init(CSPD this)
{
  ...
  GPIO_PinAFConfig(pDParams_str->hAPort, F2XX_GPIOPin2Source(pDParams_str->hAPin), bGPIOAF);
  GPIO_PinAFConfig(pDParams_str->hBPort, F2XX_GPIOPin2Source(pDParams_str->hBPin), bGPIOAF);
