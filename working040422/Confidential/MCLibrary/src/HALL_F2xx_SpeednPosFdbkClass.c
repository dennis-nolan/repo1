/**
  ******************************************************************************
  * @file    HALL_F2xx_SpeednPosFdbkClass.c
...
#include "HALL_F2xx_SpeednPosFdbkPrivate.h"
...
static void HALL_Init(CSPD this)
{
  ...
  GPIO_PinAFConfig(pDParams_str->hH1Port, F2XX_GPIOPin2Source(pDParams_str->hH1Pin), bGPIOAF);
  GPIO_PinAFConfig(pDParams_str->hH2Port, F2XX_GPIOPin2Source(pDParams_str->hH2Pin), bGPIOAF);
  GPIO_PinAFConfig(pDParams_str->hH3Port, F2XX_GPIOPin2Source(pDParams_str->hH3Pin), bGPIOAF);
