/**
  ******************************************************************************
  * @file    HALL_SpeednPosFdbkClass.c
  * @author  STMicroelectronics - System Lab - MC Team
  * @version 4.2.0
  * @date    20-Aug-2015 18:06
  * @brief   This file contains private implementation of HALL_SpeednPosFdbk IRQ      
  ******************************************************************************
  * @attention
  *
...
#include "HALL_F30X_SpeednPosFdbkPrivate.h"
                                   ...
                                   pHALL_F30XParams_t pHALLParams)
{
  ...
  return ((CHALL_F30X_SPD)_oSpeednPosFdbk);
}
...
static void HALL_Init(CSPD this)
{
  ...
  GPIO_PinAFConfig(pDParams_str->hH1Port, F30X_GPIOPin2Source(pDParams_str->hH1Pin), pDParams_str->bH1AF);
  GPIO_PinAFConfig(pDParams_str->hH2Port, F30X_GPIOPin2Source(pDParams_str->hH2Pin), pDParams_str->bH2AF);
  GPIO_PinAFConfig(pDParams_str->hH3Port, F30X_GPIOPin2Source(pDParams_str->hH3Pin), pDParams_str->bH3AF);  
...
static void HALL_IRQHandler(void *this, unsigned char flag)
{
  ...
  {    
    ...
    {      
      ...
      hHighSpeedCapture = (uint16_t)(TIM_GetCapture1(TIMx));
