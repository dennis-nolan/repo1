...
// BOC - SISKO 05/14/2020
TIM_TimeBaseInitTypeDef MC_TIMx_TimeBaseStructure_new;   /* used to restore TIM1 configuration */
TIM_OCInitTypeDef CH1_TIMx_OCInitStructure_new;          /* used to restore TIM1 channel 1 config */
TIM_OCInitTypeDef CH2_TIMx_OCInitStructure_new;          /* used to restore TIM1 channel 2 config */
TIM_OCInitTypeDef CH3_TIMx_OCInitStructure_new;          /* used to restore TIM1 channel 3 config */
// EOC
...
static void IHD2_TIMxInit(TIM_TypeDef* TIMx, CPWMC this)
{
  ...
  // BOC - SISKO 05/14/2020
  MC_TIMx_TimeBaseStructure_new = TIMx_TimeBaseStructure;
  // EOC
  ...
  // BOC - SISKO 05/14/2020
  CH1_TIMx_OCInitStructure_new = TIMx_OCInitStructure;
  // EOC
  ...
  // BOC - SISKO 05/14/2020
  CH2_TIMx_OCInitStructure_new = TIMx_OCInitStructure;
  // EOC
