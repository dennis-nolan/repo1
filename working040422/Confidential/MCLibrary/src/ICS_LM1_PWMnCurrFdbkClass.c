...
//---------------------BETH ADDED SW056 05-10-16
/* Global structures for application use */
TIM_TimeBaseInitTypeDef MC_TIMx_TimeBaseStructure;
TIM_OCInitTypeDef CH1_TIMx_OCInitStructure, CH2_TIMx_OCInitStructure,
...
static void ILM1_TIM1Init(CPWMC this)
{
  ...
  //----------------BOC BETH SW056 05-10-16
   MC_TIMx_TimeBaseStructure = TIMx_TimeBaseStructure;
  //------------EOC 
  ...
  TIM_OC1Init(TIM1, &TIMx_OCInitStructure); 
   //----------------BOC BETH SW056 05-10-16
   CH1_TIMx_OCInitStructure = TIMx_OCInitStructure;
  //------------EOC   
  ...
  TIM_OC2Init(TIM1, &TIMx_OCInitStructure); 
   //----------------BOC BETH SW056 05-10-16
  CH2_TIMx_OCInitStructure = TIMx_OCInitStructure;
  //------------EOC      
  ...
  TIM_OC3Init(TIM1, &TIMx_OCInitStructure);   
   //----------------BOC BETH SW056 05-10-16
  CH3_TIMx_OCInitStructure = TIMx_OCInitStructure;
  //------------EOC   
