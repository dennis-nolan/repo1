...
Curr_Components MCM_Clarke(Curr_Components Curr_Input)
{
  ...
  ia = Curr_Input.qI_Component1;
  ib = Curr_Input.qI_Component2;
  ic = -(ia+ib);
  ...
  if(ic>totali) totali = ic;
  

  #define totalcurrenttc 10
slong0 = totali;  
slong0 = slong0 - (totalcurrent>>totalcurrenttc);
totalcurrent = totalcurrent + slong0;
