/**
  ******************************************************************************
  * @file    R1_F2XX_PWMnCurrFdbkClass.c
  * @author  STMicroelectronics - System Lab - MC Team
  * @version 4.2.0
  * @date    20-Aug-2015 18:06
  * @brief   This file contains private implementation of R1_F2XX_PWMnCurrFdbk IRQ      
  ******************************************************************************
  * @attention
  *
...
#include "R1_F2XX_PWMnCurrFdbkPrivate.h"
...
#define DCLASS_VARS  ((_DCR1F2XX_PWMC)(((_CPWMC) this)->DerivedClass))->DVars_str
...
#else
	_DCR1F2XX_PWMC_t R1F2XX_PWMCpool[MAX_DRV_PWMC_NUM];
	unsigned char R1F2XX_PWMC_Allocated = 0u;
#endif

static void* R1F2XX_IRQHandler(void *this, unsigned char flag);
static void R1F2XX_Init(CPWMC this);
static void R1F2XX_TIMxInit(TIM_TypeDef* TIMx, TIM_TypeDef* TIMx_2, CPWMC this);
static void R1F2XX_CurrentReadingCalibration(CPWMC this);
static void R1F2XX_GetPhaseCurrents(CPWMC this,Curr_Components* pStator_Currents);
static void R1F2XX_TurnOnLowSides(CPWMC this);
static void R1F2XX_SwitchOnPWM(CPWMC this);
static void R1F2XX_SwitchOffPWM(CPWMC this);
static void R1F2XX_1ShuntMotorVarsInit(CPWMC this);
static void R1F2XX_1ShuntMotorVarsRestart(CPWMC this);
static uint16_t R1F2XX_CalcDutyCycles(CPWMC this);
static uint16_t R1F2XX_ExecRegularConv(CPWMC this, uint8_t bChannel);
static void R1F2XX_ADC_SetSamplingTime(CPWMC this, ADConv_t ADConv_struct);
static void R1F2XX_HFCurrentsCalibration(CPWMC this,Curr_Components* pStator_Currents);
static uint16_t R1F2XX_IsOverCurrentOccurred(CPWMC this);
...
CR1F2XX_PWMC R1F2XX_NewObject(pPWMnCurrFdbkParams_t pPWMnCurrFdbkParams, pR1_DDParams_t pR1_DDParams)
{
	...
	_DCR1F2XX_PWMC _oR1_F2XX;

	_oPWMnCurrFdbk = (_CPWMC)PWMC_NewObject(pPWMnCurrFdbkParams);

	#ifdef MC_CLASS_DYNAMIC
		_oR1_F2XX = (_DCR1F2XX_PWMC)calloc(1u,sizeof(_DCR1F2XX_PWMC_t));
	#else
		if (R1F2XX_PWMC_Allocated  < MAX_DRV_PWMC_NUM)
		{
			_oR1_F2XX = &R1F2XX_PWMCpool[R1F2XX_PWMC_Allocated++];
		}
		else
		{
			_oR1_F2XX = MC_NULL;
	...
	_oR1_F2XX->pDParams_str = pR1_DDParams;
	_oPWMnCurrFdbk->DerivedClass = (void*)_oR1_F2XX;
	
	_oPWMnCurrFdbk->Methods_str.pIRQ_Handler = &R1F2XX_IRQHandler;
	Set_IRQ_Handler(pR1_DDParams->IRQnb, (_CMCIRQ)_oPWMnCurrFdbk);
  
  _oPWMnCurrFdbk->Methods_str.pPWMC_Init = &R1F2XX_Init;
  _oPWMnCurrFdbk->Methods_str.pPWMC_GetPhaseCurrents = &R1F2XX_GetPhaseCurrents;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SwitchOffPWM = &R1F2XX_SwitchOffPWM;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SwitchOnPWM = &R1F2XX_SwitchOnPWM;        
  _oPWMnCurrFdbk->Methods_str.pPWMC_CurrentReadingCalibr = 
                                                 &R1F2XX_CurrentReadingCalibration;         
  _oPWMnCurrFdbk->Methods_str.pPWMC_TurnOnLowSides = &R1F2XX_TurnOnLowSides;         
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetADCSampPointSect1 = 
                                                      &R1F2XX_CalcDutyCycles;        
  ...
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetADCSampPointSect6 = 
                                                      &R1F2XX_CalcDutyCycles;
  _oPWMnCurrFdbk->Methods_str.pPWMC_ExecRegularConv= &R1F2XX_ExecRegularConv;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetSamplingTime= &R1F2XX_ADC_SetSamplingTime;
  _oPWMnCurrFdbk->Methods_str.pPWMC_IsOverCurrentOccurred = 
    &R1F2XX_IsOverCurrentOccurred;

	return ((CR1F2XX_PWMC)_oPWMnCurrFdbk);
}
...
/** @defgroup R1_F2XX_class_private_methods R1_F2XX class private methods
* @{
*/
...
static void R1F2XX_Init(CPWMC this)
{
  ...
  pDVars_str =   &(((_DCR1F2XX_PWMC)(((_CPWMC) this)->DerivedClass))->DVars_str);
  pDParams_str =  ((_DCR1F2XX_PWMC)(((_CPWMC) this)->DerivedClass))->pDParams_str;
  
  pVars_str->bMotor = (pDParams_str->bInstanceNbr==1u?M1:M2);
  
  R1F2XX_1ShuntMotorVarsInit(this);
  ...
  if (pDParams_str->TIMx == TIM1)
  {
    ...
    R1F2XX_TIMxInit(TIMx, TIMx_2, this);
  ...
  R1F2XX_1ShuntMotorVarsRestart(this);
...
static void R1F2XX_CurrentReadingCalibration(CPWMC this)
{
  ...
  ((_CPWMC) this)->Methods_str.pPWMC_GetPhaseCurrents = &R1F2XX_HFCurrentsCalibration;
  
  R1F2XX_SwitchOnPWM(this);
  ...
  ((_CPWMC) this)->Methods_str.pPWMC_GetPhaseCurrents = &R1F2XX_GetPhaseCurrents;  
}
...
/**
  * @brief  R1_F2XX implement MC IRQ function TIMER Update and DMA TC
  * @param  this related object
...
static uint16_t R1F2XX_IsOverCurrentOccurred(CPWMC this)
{
  TIM_TypeDef*  LocalTIMx = ((_DCR1F2XX_PWMC)(((_CPWMC) this)->DerivedClass))->
    pDParams_str->TIMx;
