/**
  ******************************************************************************
  * @file    R1_LM1_PWMnCurrFdbkClass.c
  * @author  STMicroelectronics - System Lab - MC Team
  * @version 4.2.0
  * @date    20-Aug-2015 18:06
  * @brief   This file contains private implementation of R1_LM1_PWMnCurrFdbk IRQ      
  ******************************************************************************
  * @attention
  *
...
#include "R1_LM1_PWMnCurrFdbkPrivate.h"
...
#define DCLASS_PARAMS ((_DCR1LM1_PWMC)(((_CPWMC) this)->DerivedClass))->pDParams_str
...
#else
	_DCR1LM1_PWMC_t R1LM1_PWMCpool[MAX_DRV_PWMC_NUM];
	unsigned char R1LM1_PWMC_Allocated = 0u;
#endif

static void* R1LM1_IRQHandler(void *this, unsigned char flag);
static void R1LM1_Init(CPWMC this);
static void R1LM1_TIMxInit(TIM_TypeDef* TIMx, TIM_TypeDef* TIMx_2, CPWMC this);
static void R1LM1_CurrentReadingCalibration(CPWMC this);
static void R1LM1_GetPhaseCurrents(CPWMC this,Curr_Components* pStator_Currents);
static void R1LM1_TurnOnLowSides(CPWMC this);
static void R1LM1_SwitchOnPWM(CPWMC this);
static void R1LM1_SwitchOffPWM(CPWMC this);
static void R1LM1_1ShuntMotorVarsInit(CPWMC this);
static void R1LM1_1ShuntMotorVarsRestart(CPWMC this);
static uint16_t R1LM1_CalcDutyCycles(CPWMC this);
static uint16_t R1LM1_ExecRegularConv(CPWMC this, uint8_t bChannel);
static void R1LM1_ADC_SetSamplingTime(CPWMC this, ADConv_t ADConv_struct);
static uint16_t R1LM1_IsOverCurrentOccurred(CPWMC this);
...
CR1LM1_PWMC R1LM1_NewObject(pPWMnCurrFdbkParams_t pPWMnCurrFdbkParams, pR1_LM1Params_t pR1_LM1Params)
{
	...
	_DCR1LM1_PWMC _oR1_LM1;

	_oPWMnCurrFdbk = (_CPWMC)PWMC_NewObject(pPWMnCurrFdbkParams);

	#ifdef MC_CLASS_DYNAMIC
		_oR1_LM1 = (_DCR1LM1_PWMC)calloc(1u,sizeof(_DCR1LM1_PWMC_t));
	#else
		if (R1LM1_PWMC_Allocated  < MAX_DRV_PWMC_NUM)
		{
			_oR1_LM1 = &R1LM1_PWMCpool[R1LM1_PWMC_Allocated++];
		}
		else
		{
			_oR1_LM1 = MC_NULL;
  ...
  _oPWMnCurrFdbk->Methods_str.pPWMC_Init = &R1LM1_Init;
  _oPWMnCurrFdbk->Methods_str.pPWMC_GetPhaseCurrents = &R1LM1_GetPhaseCurrents;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SwitchOffPWM = &R1LM1_SwitchOffPWM;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SwitchOnPWM = &R1LM1_SwitchOnPWM;        
  _oPWMnCurrFdbk->Methods_str.pPWMC_CurrentReadingCalibr = 
                                                 &R1LM1_CurrentReadingCalibration;         
  _oPWMnCurrFdbk->Methods_str.pPWMC_TurnOnLowSides = &R1LM1_TurnOnLowSides;         
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetADCSampPointSect1 = 
                                                      &R1LM1_CalcDutyCycles;        
  ...
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetADCSampPointSect6 = 
                                                      &R1LM1_CalcDutyCycles;
  _oPWMnCurrFdbk->Methods_str.pPWMC_ExecRegularConv= &R1LM1_ExecRegularConv;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetSamplingTime= &R1LM1_ADC_SetSamplingTime;
  _oPWMnCurrFdbk->Methods_str.pPWMC_IsOverCurrentOccurred = 
    &R1LM1_IsOverCurrentOccurred;
  
	return ((CR1LM1_PWMC)_oPWMnCurrFdbk);
}
...
/** @defgroup R1_LM1_class_private_methods R1_LM1 class private methods
* @{
*/
...
static void R1LM1_Init(CPWMC this)
{
  ...
  pDVars_str =   &(((_DCR1LM1_PWMC)(((_CPWMC) this)->DerivedClass))->DVars_str);
  pDParams_str =  ((_DCR1LM1_PWMC)(((_CPWMC) this)->DerivedClass))->pDParams_str;
  AuxTIM = pDParams_str->AuxTIM;
  
  R1LM1_1ShuntMotorVarsInit(this);
  ...
  R1LM1_TIMxInit(TIM1, AuxTIM, this);
  ...
  R1LM1_1ShuntMotorVarsRestart(this);
...
static void R1LM1_CurrentReadingCalibration(CPWMC this)
{
  ...
  R1LM1_ADC_SetSamplingTime(this,ADConv_struct);
...
/**
  * @brief  R1_LM1 implement MC IRQ function TIMER Update and DMA TC
