/**
  ******************************************************************************
  * @file    R3_2_F30X_PWMnCurrFdbkClass.c
...
#include "R3_2_F30X_PWMnCurrFdbkPrivate.h"
...
#define DCLASS_PARAMS ((_DCR3_2_F30X_PWMC)(((_CPWMC) this)->DerivedClass))->pDParams_str
#define DCLASS_VARS  ((_DCR3_2_F30X_PWMC)(((_CPWMC) this)->DerivedClass))->DVars_str
...
#else
_DCR3_2_F30X_PWMC_t R3_2_F30X_PWMCpool[MAX_DRV_PWMC_NUM];
unsigned char R3_2_F30X_PWMC_Allocated = 0u;
#endif
...
static void R3_2_F30X_Init(CPWMC this);
static void R3_2_F30X_TIMxInit(TIM_TypeDef* TIMx, CPWMC this);
static void R3_2_F30X_CurrentReadingCalibration(CPWMC this);
static void R3_2_F30X_GetPhaseCurrents(CPWMC this,Curr_Components* pStator_Currents);
static void R3_2_F30X_TurnOnLowSides(CPWMC this);
static void R3_2_F30X_SwitchOnPWM(CPWMC this);
static void R3_2_F30X_SwitchOffPWM(CPWMC this);
static uint16_t R3_2_F30X_WriteTIMRegisters(CPWMC this);
static uint16_t R3_2_F30X_SetADCSampPointSect1(CPWMC this);
static uint16_t R3_2_F30X_SetADCSampPointSect2(CPWMC this);
static uint16_t R3_2_F30X_SetADCSampPointSect3(CPWMC this);
static uint16_t R3_2_F30X_SetADCSampPointSect4(CPWMC this);
static uint16_t R3_2_F30X_SetADCSampPointSect5(CPWMC this);
static uint16_t R3_2_F30X_SetADCSampPointSect6(CPWMC this);
static void *R3_2_F30X_IRQHandler(void *this, unsigned char flag);
static uint16_t R3_2_F30X_ExecRegularConv(CPWMC this, uint8_t bChannel);
static void R3_2_F30X_ADC_SetSamplingTime(CPWMC this, ADConv_t ADConv_struct);
static void R3_2_F30X_HFCurrentsCalibrationAB(CPWMC this,Curr_Components* pStator_Currents);
static void R3_2_F30X_HFCurrentsCalibrationC(CPWMC this,Curr_Components* pStator_Currents);
static uint16_t R3_2_F30X_IsOverCurrentOccurred(CPWMC this);
...
uint32_t R3_2_F30X_ADC_InjectedChannelConfig(ADC_TypeDef* ADCx, uint8_t ADC_Channel, uint8_t Rank, uint8_t ADC_SampleTime, uint8_t SequencerLength, uint16_t ADC_ExternalTriggerInjectedPolarity, uint16_t ADC_ExternalTriggerInjected);
uint32_t R3_2_F30X_OPAMP_Init(uint32_t OPAMP_Selection, OPAMP_InitTypeDef* OPAMP_InitStruct);
                                    ...
                                    pR3_2_F30XParams_t pR3_2_F30XParams)
{
  ...
  _DCR3_2_F30X_PWMC _oR3_2_F30X;
  
  _oPWMnCurrFdbk = (_CPWMC)PWMC_NewObject(pPWMnCurrFdbkParams);
  
#ifdef MC_CLASS_DYNAMIC
  _oR3_2_F30X = (_DCR3_2_F30X_PWMC)calloc(1u,sizeof(_DCR3_2_F30X_PWMC_t));
#else
  if (R3_2_F30X_PWMC_Allocated  < MAX_DRV_PWMC_NUM)
  {
    _oR3_2_F30X = &R3_2_F30X_PWMCpool[R3_2_F30X_PWMC_Allocated++];
  }
  else
  {
    _oR3_2_F30X = MC_NULL;
  ...
  _oR3_2_F30X->pDParams_str = pR3_2_F30XParams;
  _oPWMnCurrFdbk->DerivedClass = (void*)_oR3_2_F30X;
  
  _oPWMnCurrFdbk->Methods_str.pIRQ_Handler = &R3_2_F30X_IRQHandler;
  
  Set_IRQ_Handler(pR3_2_F30XParams->IRQnb, (_CMCIRQ)_oPWMnCurrFdbk);
  
  _oPWMnCurrFdbk->Methods_str.pPWMC_Init = &R3_2_F30X_Init;
  _oPWMnCurrFdbk->Methods_str.pPWMC_GetPhaseCurrents = &R3_2_F30X_GetPhaseCurrents;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SwitchOffPWM = &R3_2_F30X_SwitchOffPWM;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SwitchOnPWM = &R3_2_F30X_SwitchOnPWM;        
  _oPWMnCurrFdbk->Methods_str.pPWMC_CurrentReadingCalibr = 
                                                 &R3_2_F30X_CurrentReadingCalibration;         
  _oPWMnCurrFdbk->Methods_str.pPWMC_TurnOnLowSides = &R3_2_F30X_TurnOnLowSides;         
  ...
  _oPWMnCurrFdbk->Methods_str.pPWMC_ExecRegularConv= &R3_2_F30X_ExecRegularConv;
  
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetSamplingTime= &R3_2_F30X_ADC_SetSamplingTime;
  
  _oPWMnCurrFdbk->Methods_str.pPWMC_IsOverCurrentOccurred = 
    &R3_2_F30X_IsOverCurrentOccurred;
  return ((CR3_2_F30X_PWMC)_oPWMnCurrFdbk);
}
...
/** @defgroup R3_2_F30X_class_private_methods R3_2_F30X class private methods
* @{
*/
...
static void R3_2_F30X_Init(CPWMC this)
{
  ...
  pR3_2_F30XOPAMPParams_t pDOPAMPParams_str = pDParams_str->pOPAMPParams;
  ...
  if ((pDParams_str->wAHBPeriph == RCC_AHBPeriph_ADC12) &&
      (pDParams_str->ADCx_2 == ADC3))
  {
  ...
  if (pDOPAMPParams_str)
  {
    ...
    OPAMP_PGAConfig(OPAMP_Selection_OPAMP1,
    ...
    OPAMP_InitStruct.OPAMP_NonInvertingInput = pDOPAMPParams_str->wOPAMP2_NonInvertingInput_PHC;
    OPAMP_Init(OPAMP_Selection_OPAMP3,&OPAMP_InitStruct);
    OPAMP_PGAConfig(OPAMP_Selection_OPAMP3,
                    pDOPAMPParams_str->wOPAMP_PGAGain,
                    pDOPAMPParams_str->OPAMP_PGAConnect);
  ...
  if (pDOCPA_COMPParams_str)
  {
    ...
    else
    {
      ...
      {
        R3_2_F30X_SetAOReferenceVoltage(DAC_Channel_1, (uint16_t)(pDParams_str->hDAC_OCP_Threshold));
      }
      else if (pDOCPA_COMPParams_str->wInvertingInput == COMP_InvertingInput_DAC1OUT2)
      {
        R3_2_F30X_SetAOReferenceVoltage(DAC_Channel_2, (uint16_t)(pDParams_str->hDAC_OCP_Threshold));
      }
      else
      {
      }
  ...
  if (pDOVP_COMPParams_str)
  {
    ...
    else
    {
      ...
      {
        R3_2_F30X_SetAOReferenceVoltage(DAC_Channel_1, (uint16_t)(pDParams_str->hDAC_OVP_Threshold));
      }
      else if (pDOVP_COMPParams_str->wInvertingInput == COMP_InvertingInput_DAC1OUT2)
      {
        R3_2_F30X_SetAOReferenceVoltage(DAC_Channel_2, (uint16_t)(pDParams_str->hDAC_OVP_Threshold));
      }
      else
      {
      }
  ...
  if (pDParams_str->bInstanceNbr != 1u)
  {
    ...
    wAux1 = pDParams_str->ADCx_1->SMPR1;
    wAux2 = pDParams_str->ADCx_1->SMPR2;
    wAux3 = pDParams_str->ADCx_2->SMPR1;
    wAux4 = pDParams_str->ADCx_2->SMPR2;
  }
  
  /* Init ADC peripherals and related IRQ handler*/
  ADC_DeInit(pDParams_str->ADCx_1);
  ADC_DeInit(pDParams_str->ADCx_2);
  
  if (pDParams_str->bInstanceNbr != 1u)
  {
    /* It restores the sampling time settings by the first instance */ 
    pDParams_str->ADCx_1->SMPR1 = wAux1;
    pDParams_str->ADCx_1->SMPR2 = wAux2;  
    pDParams_str->ADCx_2->SMPR1 = wAux3;
    pDParams_str->ADCx_2->SMPR2 = wAux4;
  }
  
  if (pDParams_str->bInstanceNbr == 1u)
  {
    if ((pDParams_str->regconvADCx != pDParams_str->ADCx_1) &&
        (pDParams_str->regconvADCx != pDParams_str->ADCx_2))
    {
  ...
  ADC_CommonInitStructure.ADC_DMAMode=ADC_DMAMode_OneShot;
  ADC_CommonInitStructure.ADC_TwoSamplingDelay= 0u;
  ADC_CommonInit(pDParams_str->ADCx_1, &ADC_CommonInitStructure);
  ADC_CommonInit(pDParams_str->ADCx_2, &ADC_CommonInitStructure);
  
  ADC_VoltageRegulatorCmd(pDParams_str->ADCx_1, ENABLE);
  ADC_VoltageRegulatorCmd(pDParams_str->ADCx_2, ENABLE);
  ...
  ADC_SelectCalibrationMode(pDParams_str->ADCx_1,ADC_CalibrationMode_Single);    
  ADC_StartCalibration(pDParams_str->ADCx_1);
  while (ADC_GetCalibrationStatus(pDParams_str->ADCx_1)== SET )
  {
  }
  
  ADC_SelectCalibrationMode(pDParams_str->ADCx_2,ADC_CalibrationMode_Single);
  ADC_StartCalibration(pDParams_str->ADCx_2);
  while (ADC_GetCalibrationStatus(pDParams_str->ADCx_2)== SET )
  {
  }
  ...
  if ((pDParams_str->ADCx_1 == ADC1) || (pDParams_str->ADCx_1 == ADC2))
  {
    NVIC_InitStructure.NVIC_IRQChannel = (uint8_t) ADC1_2_IRQn;
  }
  else if ((pDParams_str->ADCx_1 == ADC3) || (pDParams_str->ADCx_1 == ADC4))
  {
  ...
  ADC_Cmd(pDParams_str->ADCx_1, ENABLE);
  ADC_Cmd(pDParams_str->ADCx_2, ENABLE);
  ...
  /* Configure the ADCx_1&2 for reg conversions */
  ADC_StructInit(&ADC_InitStructure);
  ADC_InitStructure.ADC_ContinuousConvMode = ADC_ContinuousConvMode_Disable;
  ADC_InitStructure.ADC_Resolution = ADC_Resolution_12b; 
  ...
  ADC_Init(pDParams_str->ADCx_1, &ADC_InitStructure);
  ADC_Init(pDParams_str->ADCx_2, &ADC_InitStructure);
    
  if (pDParams_str->pOPAMPParams)
  {
    /* ADC channel config when using internal OPAMP */
    pDVars_str->wADC_JSQR_phA = R3_2_F30X_ADC_InjectedChannelConfig(ADC1, ADC_Channel_3, 1u, pDParams_str->b_IaSamplingTime, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
    pDVars_str->wADC_JSQR_phB = R3_2_F30X_ADC_InjectedChannelConfig(ADC3, ADC_Channel_1, 1u, pDParams_str->b_IbSamplingTime, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
  ...
  else
  {
    ...
    pDVars_str->wADC_JSQR_phA = R3_2_F30X_ADC_InjectedChannelConfig(pDParams_str->ADCx_1, pDParams_str->bIaChannel, 1u, pDParams_str->b_IaSamplingTime, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
    pDVars_str->wADC_JSQR_phB = R3_2_F30X_ADC_InjectedChannelConfig(pDParams_str->ADCx_2, pDParams_str->bIbChannel, 1u, pDParams_str->b_IbSamplingTime, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
    pDVars_str->wADC_JSQR_phC = R3_2_F30X_ADC_InjectedChannelConfig(pDParams_str->ADCx_2, pDParams_str->bIcChannel, 1u, pDParams_str->b_IcSamplingTime, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
    R3_2_F30X_ADC_InjectedChannelConfig(pDParams_str->ADCx_2, pDParams_str->bIaChannel, 1u, pDParams_str->b_IaSamplingTime, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
    R3_2_F30X_ADC_InjectedChannelConfig(pDParams_str->ADCx_1, pDParams_str->bIbChannel, 1u, pDParams_str->b_IbSamplingTime, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
    R3_2_F30X_ADC_InjectedChannelConfig(pDParams_str->ADCx_1, pDParams_str->bIcChannel, 1u, pDParams_str->b_IcSamplingTime, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
  }
  
  ADC_SelectQueueOfContextMode(pDParams_str->ADCx_1,ENABLE);
  ADC_SelectQueueOfContextMode(pDParams_str->ADCx_2,ENABLE);
  
  pDParams_str->ADCx_1->JSQR = R3_2_F30X_ADC_InjectedChannelConfig(pDParams_str->ADCx_1, 0u, 1u, 0u, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
  pDParams_str->ADCx_2->JSQR = R3_2_F30X_ADC_InjectedChannelConfig(pDParams_str->ADCx_2, 0u, 1u, 0u, 1u, ADC_ExternalTrigInjecEventEdge_RisingEdge, pDVars_str->ADC_ExternalTriggerInjected);
  pDParams_str->ADCx_1->CR |= ADC_CR_JADSTART;
  pDParams_str->ADCx_2->CR |= ADC_CR_JADSTART;
  ...
  while (ADC_GetFlagStatus(pDParams_str->ADCx_1,ADC_FLAG_JEOS)==RESET)
  {
  }
  while (ADC_GetFlagStatus(pDParams_str->ADCx_2,ADC_FLAG_JEOS)==RESET)
  {
  }
  
  /* ADCx_1 Injected conversions end interrupt enabling */
  ADC_ClearFlag(pDParams_str->ADCx_1, ADC_FLAG_JEOS);
  ADC_ClearFlag(pDParams_str->ADCx_2, ADC_FLAG_JEOS);
  ADC_ITConfig(pDParams_str->ADCx_1, ADC_IT_JEOS, ENABLE);
...
static void R3_2_F30X_CurrentReadingCalibration(CPWMC this)
{
  ...
  ((_CPWMC) this)->Methods_str.pPWMC_GetPhaseCurrents = &R3_2_F30X_HFCurrentsCalibrationAB;
  ...
  if (pDOPAMPParams_str)
  {
    ...
    pDVars_str->wOAMP1CR = R3_2_F30X_OPAMP_Init(OPAMP_Selection_OPAMP1,&OPAMP_InitStruct1);
    OPAMP_InitStruct2.OPAMP_InvertingInput = pDOPAMPParams_str->wOPAMP2_InvertingInput;
    OPAMP_InitStruct2.OPAMP_NonInvertingInput = pDOPAMPParams_str->wOPAMP2_NonInvertingInput_PHA;
    pDVars_str->wOAMP2CR = R3_2_F30X_OPAMP_Init(OPAMP_Selection_OPAMP3,&OPAMP_InitStruct2);
  }
  else
  {
    pDVars_str->wADC1_JSQR = pDVars_str->wADC_JSQR_phB;
    pDVars_str->wADC2_JSQR = pDVars_str->wADC_JSQR_phA;
  }
  
  R3_2_F30X_SwitchOnPWM(this);
  ...
  /* Change function to be executed in ADCx_ISR */ 
  ((_CPWMC) this)->Methods_str.pPWMC_GetPhaseCurrents = &R3_2_F30X_HFCurrentsCalibrationC;
  ...
  if (pDOPAMPParams_str)
  {
    ...
    pDVars_str->wOAMP2CR = R3_2_F30X_OPAMP_Init(OPAMP_Selection_OPAMP3,&OPAMP_InitStruct3);
  }
  else
  {
  ...
  ((_CPWMC) this)->Methods_str.pPWMC_GetPhaseCurrents = &R3_2_F30X_GetPhaseCurrents;
...
static void R3_2_F30X_GetPhaseCurrents(CPWMC this,Curr_Components* pStator_Currents)
{
  ...
  pDVars_t pDVars_str = &(((_DCR3_2_F30X_PWMC)(((_CPWMC) this)->DerivedClass))->DVars_str);
  pDParams_t pDParams_str = DCLASS_PARAMS;
  
  /* Reset the SOFOC flag to indicate the start of FOC algorithm*/
  pDVars_str->bSoFOC = 0u;
  
  hReg1 = (uint16_t)(pDParams_str->ADCx_1->JDR1); 
  hReg2 = (uint16_t)(pDParams_str->ADCx_2->JDR1);
...
{  
  ...
  if (pDVars_str->bIndex < NB_CONVERSIONS)
  {
    pDVars_str-> wPhaseAOffset += pDParams_str->ADCx_2->JDR1;
    pDVars_str-> wPhaseBOffset += pDParams_str->ADCx_1->JDR1;
    pDVars_str->bIndex++;
  }
}
...
static void R3_2_F30X_HFCurrentsCalibrationC(CPWMC this,Curr_Components* pStator_Currents)
{
  ...
  if (pDVars_str->bIndex < NB_CONVERSIONS)
  {
    pDVars_str-> wPhaseCOffset += pDParams_str->ADCx_2->JDR1; 
    pDVars_str->bIndex++;
  }
}
...
static uint16_t R3_2_F30X_SetADCSampPointSect1(CPWMC this)
{
  ...
  Vars_t *pBaseVars = &((_CPWMC) this)->Vars_str;
  pDParams_t pDParams_str =  ((_DCR3_2_F30X_PWMC)(((_CPWMC) this)->DerivedClass))->pDParams_str;
      ...
      ((uint16_t)(PWM_PERIOD-pBaseVars->hCntPhB) > pDParams_str->hTafter))
  {
    ...
    if (pDOPAMPParams_str)
    {
      ...
      OPAMP_InitStruct1.OPAMP_InvertingInput = pDOPAMPParams_str->wOPAMP_InvertingInput;
      OPAMP_InitStruct1.OPAMP_NonInvertingInput = pDOPAMPParams_str->wOPAMP_NonInvertingInput_PHB;
      pLocalVars_Str->wOAMP1CR = R3_2_F30X_OPAMP_Init(OPAMP_Selection_OPAMP1,&OPAMP_InitStruct1);
      OPAMP_InitStruct2.OPAMP_InvertingInput = pDOPAMPParams_str->wOPAMP2_InvertingInput;
      OPAMP_InitStruct2.OPAMP_NonInvertingInput = pDOPAMPParams_str->wOPAMP2_NonInvertingInput_PHA;
      pLocalVars_Str->wOAMP2CR = R3_2_F30X_OPAMP_Init(OPAMP_Selection_OPAMP3,&OPAMP_InitStruct2);
    }
    else
    {
      pLocalVars_Str->wADC1_JSQR = pLocalVars_Str->wADC_JSQR_phB;
      pLocalVars_Str->wADC2_JSQR = pLocalVars_Str->wADC_JSQR_phA;
    } 
  }
  else
  {
  ...
  return R3_2_F30X_WriteTIMRegisters(this);
}
...
static void *R3_2_F30X_IRQHandler(void *this, unsigned char flag)
{
  ...
  if (flag == 2u)
  {
    ...
    pDVars_str->OverCurrentFlag = TRUE;
  }
  else if (flag == 3u)
  {
    pDParams_str->TIMx->BDTR |= TIM_OSSIState_Enable;
    pDVars_str->OverVoltageFlag = TRUE;
  ...
  else
  {
    ...
    if (pDOPAMPParams_str)
    {
      while (pDParams_str->ADCx_1->JSQR != 0x00000000u)
      {
      }
      *(__IO uint32_t *) (OPAMP_BASE + OPAMP_Selection_OPAMP1) = pDVars_str->wOAMP1CR;
      *(__IO uint32_t *) (OPAMP_BASE + OPAMP_Selection_OPAMP3) = pDVars_str->wOAMP2CR;
    }
    
    /* Write value in the Queue */
    pDParams_str->ADCx_1->JSQR = pDVars_str->wADC1_JSQR;
    pDParams_str->ADCx_2->JSQR = pDVars_str->wADC2_JSQR;
