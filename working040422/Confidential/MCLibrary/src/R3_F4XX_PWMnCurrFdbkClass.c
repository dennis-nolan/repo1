/**
  ******************************************************************************
  * @file    R3_F4XX_PWMnCurrFdbkClass.c
...
#include "R3_F4XX_PWMnCurrFdbkPrivate.h"
...
#define DCLASS_PARAMS ((_DCR3F4XX_PWMC)(((_CPWMC) this)->DerivedClass))->pDParams_str
#define DCLASS_VARS  ((_DCR3F4XX_PWMC)(((_CPWMC) this)->DerivedClass))->DVars_str
...
#else
_DCR3F4XX_PWMC_t R3F4XX_PWMCpool[MAX_DRV_PWMC_NUM];
unsigned char R3F4XX_PWMC_Allocated = 0u;
#endif

static void R3F4XX_Init(CPWMC this);
static void R3F4XX_TIMxInit(TIM_TypeDef* TIMx, CPWMC this);
static void R3F4XX_CurrentReadingCalibration(CPWMC this);
static void R3F4XX_GetPhaseCurrents(CPWMC this,Curr_Components* pStator_Currents);
static void R3F4XX_TurnOnLowSides(CPWMC this);
static void R3F4XX_SwitchOnPWM(CPWMC this);
static void R3F4XX_SwitchOffPWM(CPWMC this);
static uint16_t R3F4XX_WriteTIMRegisters(CPWMC this);
static uint16_t R3F4XX_SetADCSampPointSect1(CPWMC this);
static uint16_t R3F4XX_SetADCSampPointSect2(CPWMC this);
static uint16_t R3F4XX_SetADCSampPointSect3(CPWMC this);
static uint16_t R3F4XX_SetADCSampPointSect4(CPWMC this);
static uint16_t R3F4XX_SetADCSampPointSect5(CPWMC this);
static uint16_t R3F4XX_SetADCSampPointSect6(CPWMC this);
static void *R3F4XX_IRQHandler(void *this, unsigned char flag);
static uint16_t R3F4XX_ExecRegularConv(CPWMC this, uint8_t bChannel);
static void R3F4XX_ADC_SetSamplingTime(CPWMC this, ADConv_t ADConv_struct);
static void R3F4XX_HFCurrentsCalibrationAB(CPWMC this,Curr_Components* pStator_Currents);
static void R3F4XX_HFCurrentsCalibrationC(CPWMC this,Curr_Components* pStator_Currents);
static uint16_t R3F4XX_IsOverCurrentOccurred(CPWMC this);
static uint16_t F4XX_GPIOPin2Source(uint16_t GPIO_Pin);
static void R3F4XX_RLDetectionModeEnable(CPWMC this);
static void R3F4XX_RLDetectionModeDisable(CPWMC this);
static uint16_t R3F4XX_RLDetectionModeSetDuty(CPWMC this, uint16_t hDuty);
static void R3F4XX_RLGetPhaseCurrents(CPWMC this,Curr_Components* pStator_Currents);
static void R3F4XX_RLTurnOnLowSides(CPWMC this);
static void R3F4XX_RLSwitchOnPWM(CPWMC this);

/**
* @brief  Creates an object of the class R3_F4XX
...
* @retval CR3F4XX_PWMC new instance of R3_F4XX object
*/
CR3F4XX_PWMC R3F4XX_NewObject(pPWMnCurrFdbkParams_t pPWMnCurrFdbkParams, 
                                    pR3_DDParams_t pR3_DDParams)
{
  _CPWMC _oPWMnCurrFdbk;
  _DCR3F4XX_PWMC _oR3_F4XX;
  
  _oPWMnCurrFdbk = (_CPWMC)PWMC_NewObject(pPWMnCurrFdbkParams);
  
#ifdef MC_CLASS_DYNAMIC
  _oR3_F4XX = (_DCR3F4XX_PWMC)calloc(1u,sizeof(_DCR3F4XX_PWMC_t));
#else
  if (R3F4XX_PWMC_Allocated  < MAX_DRV_PWMC_NUM)
  {
    _oR3_F4XX = &R3F4XX_PWMCpool[R3F4XX_PWMC_Allocated++];
  }
  else
  {
    _oR3_F4XX = MC_NULL;
  ...
  _oR3_F4XX->pDParams_str = pR3_DDParams;
  _oPWMnCurrFdbk->DerivedClass = (void*)_oR3_F4XX;
  
  _oPWMnCurrFdbk->Methods_str.pIRQ_Handler = &R3F4XX_IRQHandler;
  
  Set_IRQ_Handler(pR3_DDParams->IRQnb, (_CMCIRQ)_oPWMnCurrFdbk);
  
  _oPWMnCurrFdbk->Methods_str.pPWMC_Init = &R3F4XX_Init;
  _oPWMnCurrFdbk->Methods_str.pPWMC_GetPhaseCurrents = &R3F4XX_GetPhaseCurrents;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SwitchOffPWM = &R3F4XX_SwitchOffPWM;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SwitchOnPWM = &R3F4XX_SwitchOnPWM;        
  _oPWMnCurrFdbk->Methods_str.pPWMC_CurrentReadingCalibr = 
                                                 &R3F4XX_CurrentReadingCalibration;         
  _oPWMnCurrFdbk->Methods_str.pPWMC_TurnOnLowSides = &R3F4XX_TurnOnLowSides;         
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetADCSampPointSect1 = 
                                                      &R3F4XX_SetADCSampPointSect1;
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetADCSampPointSect2 = 
                                                      &R3F4XX_SetADCSampPointSect2;
  ...
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetADCSampPointSect6 = 
                                                      &R3F4XX_SetADCSampPointSect6;
  _oPWMnCurrFdbk->Methods_str.pPWMC_ExecRegularConv= &R3F4XX_ExecRegularConv;
  
  _oPWMnCurrFdbk->Methods_str.pPWMC_SetSamplingTime= &R3F4XX_ADC_SetSamplingTime;
  
  _oPWMnCurrFdbk->Methods_str.pPWMC_IsOverCurrentOccurred = 
    &R3F4XX_IsOverCurrentOccurred;
  
  _oPWMnCurrFdbk->Methods_str.pRLDetectionModeEnable = &R3F4XX_RLDetectionModeEnable;
  
  _oPWMnCurrFdbk->Methods_str.pRLDetectionModeDisable = &R3F4XX_RLDetectionModeDisable;
  
  _oPWMnCurrFdbk->Methods_str.pRLDetectionModeSetDuty = &R3F4XX_RLDetectionModeSetDuty;
  
  return ((CR3F4XX_PWMC)_oPWMnCurrFdbk);
}
...
/** @defgroup R3_F4XX_class_private_methods R3_F4XX class private methods
* @{
*/
...
#if defined (SAMPLING_POINT_DEBUG)
  if (pDParams_str->TIMx == TIM1)
  {
    GPIO_PinAFConfig(GPIOE, F4XX_GPIOPin2Source(GPIO_Pin_14), GPIO_AF_TIM1);
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14;
    GPIO_Init(GPIOE, &GPIO_InitStructure);
  }
  if (pDParams_str->TIMx == TIM8)
  {
    GPIO_PinAFConfig(GPIOC, F4XX_GPIOPin2Source(GPIO_Pin_9), GPIO_AF_TIM8);
...
* @param 'this': related object of class CR3F4XX_PWMC
* @retval none
*/
static void R3F4XX_TIMxInit(TIM_TypeDef* TIMx, CPWMC this)
{
...
static void R3F4XX_CurrentReadingCalibration(CPWMC this)
{
  ...
  ((_CPWMC) this)->Methods_str.pPWMC_GetPhaseCurrents = &R3F4XX_HFCurrentsCalibrationAB;
  
  pDVars_str->wADC1Channel = PHASE_A_MSK;
  pDVars_str->wADC2Channel = PHASE_B_MSK;
  
  R3F4XX_SwitchOnPWM(this);
  ...
  /* Change function to be executed in ADCx_ISR */ 
  ((_CPWMC) this)->Methods_str.pPWMC_GetPhaseCurrents = &R3F4XX_HFCurrentsCalibrationC;
  ...
  ((_CPWMC) this)->Methods_str.pPWMC_GetPhaseCurrents = &R3F4XX_GetPhaseCurrents;
...
static void R3F4XX_GetPhaseCurrents(CPWMC this,Curr_Components* pStator_Currents)
{
  uint8_t bSector;
  int32_t wAux;
  pDVars_t pDVars_str = &(((_DCR3F4XX_PWMC)(((_CPWMC) this)->DerivedClass))->DVars_str);
...
{  
  ...
  if ((pLocalDParams->LowSideOutputs)== ES_GPIO)
  {
    if ((LocalTIMx->CCER & TIMxCCER_MASK_CH123) != 0u)
    {
      GPIO_WriteBit(pLocalDParams->hCh1NPort, pLocalDParams->hCh1NPin, Bit_SET);
      GPIO_WriteBit(pLocalDParams->hCh2NPort, pLocalDParams->hCh2NPin, Bit_SET);
      GPIO_WriteBit(pLocalDParams->hCh3NPort, pLocalDParams->hCh3NPin, Bit_SET);
...
static uint16_t R3F4XX_SetADCSampPointSect1(CPWMC this)
{
  ...
  return R3F4XX_WriteTIMRegisters(this);
}
...
static void R3F4XX_RLDetectionModeEnable(CPWMC this)
{
  ...
  if (pVars->RLDetectionMode == FALSE)
  {
    ...
    pDVars->wPhaseAOffset = pDVars->wPhaseBOffset; /* Use only the offset of phB */
  }
  
  ((_CPWMC)this)->Methods_str.pPWMC_GetPhaseCurrents = &R3F4XX_RLGetPhaseCurrents;
  ((_CPWMC)this)->Methods_str.pPWMC_TurnOnLowSides = &R3F4XX_RLTurnOnLowSides;
  ((_CPWMC)this)->Methods_str.pPWMC_SwitchOnPWM = &R3F4XX_RLSwitchOnPWM;
  ((_CPWMC)this)->Methods_str.pPWMC_SwitchOffPWM = &R3F4XX_SwitchOffPWM;
...
static void R3F4XX_RLDetectionModeDisable(CPWMC this)
{
  ...
  if (pVars->RLDetectionMode == TRUE)
  {
    ...
    TIM_SetCompare1(TIMx, (uint32_t)(pDVars->Half_PWMPeriod) >> 1);
    ...
    TIM_SetCompare2(TIMx, (uint32_t)(pDVars->Half_PWMPeriod) >> 1);
    ...
    TIM_SetCompare3(TIMx, (uint32_t)(pDVars->Half_PWMPeriod) >> 1);
    
    ((_CPWMC)this)->Methods_str.pPWMC_GetPhaseCurrents = &R3F4XX_GetPhaseCurrents;
    ((_CPWMC)this)->Methods_str.pPWMC_TurnOnLowSides = &R3F4XX_TurnOnLowSides;
    ((_CPWMC)this)->Methods_str.pPWMC_SwitchOnPWM = &R3F4XX_SwitchOnPWM;
    ((_CPWMC)this)->Methods_str.pPWMC_SwitchOffPWM = &R3F4XX_SwitchOffPWM;
...
static uint16_t R3F4XX_RLDetectionModeSetDuty(CPWMC this, uint16_t hDuty)
{
  ...
  TIMx->CCR4 = (uint32_t)(PWM_PERIOD) - pParams->Ton;
  TIMx->CCR3 = pParams->Toff;
    
  TIMx->CCR1 = ((_CPWMC) this)->Vars_str.hCntPhA;
  
  /* Switch Context */
  /* Disabling trigger to avoid unwanted conversion */
  ADC1->CR2 = pDVars->wADCTriggerUnSet;
  ADC2->CR2 = pDVars->wADCTriggerUnSet;
  
  /* Enabling next Trigger */
  TIMx->CCER |= 0x1000u;
  
  /* It re-initilize AD converter in run time when using dual MC */   
  ADC1->CR2 = pDVars->wADCTriggerSet;
  ADC2->CR2 = pDVars->wADCTriggerSet;
  
  /* Change channels keeping equal to 1 element the sequencer lenght */ 
  ADC1->JSQR = PHASE_B_MSK;
  ADC2->JSQR = PHASE_A_MSK;
...
static void R3F4XX_RLGetPhaseCurrents(CPWMC this,Curr_Components* pStator_Currents)
{
  ...
  wAux = (int32_t)(ADC1->JDR1);
  wAux *= 2;
  wAux = (int32_t)(pDVars->wPhaseBOffset) - wAux;
