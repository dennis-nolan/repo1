/**
  ...
  *          definitions and memory mapping for STM32F40x devices.
  *            
...
#if !defined (STM32F40X)
 #error "Please select first the target STM32F40X device used in your application (in stm32f40x.h file)"
#endif
...
/**
 * @brief STM32F40X Standard Peripherals Library version number V0.0.2
   */
#define __STM32F40X_STDPERIPH_VERSION_MAIN   (0x00) /*!< [31:24] main version */                                  
#define __STM32F40X_STDPERIPH_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __STM32F40X_STDPERIPH_VERSION_SUB2   (0x02) /*!< [15:8]  sub2 version */
#define __STM32F40X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __STM32F40X_STDPERIPH_VERSION        ((__STM32F40X_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__STM32F40X_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__STM32F40X_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__STM32F40X_STDPERIPH_VERSION_RC))
 ...
 */
#define __MPU_PRESENT             1 /*!< STM32F40X provides an MPU */
#define __NVIC_PRIO_BITS          4 /*!< STM32F40X uses 4 Bits for the Priority Levels */
#define __Vendor_SysTickConfig    0 /*!< Set to 1 if different SysTick Config is used */
#define __FPU_PRESENT             1 /*!< FPU present                                  */

/**
 * @brief STM32F40X Interrupt Number Definition, according to the selected device 
...
#define FSMC_Bank2_R_BASE     (FSMC_R_BASE + 0x0060u)
#define FSMC_Bank3_R_BASE     (FSMC_R_BASE + 0x0080u)
