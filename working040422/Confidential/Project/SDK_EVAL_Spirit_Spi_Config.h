...
#define SPIRIT_SPI_PERIPH_RCC                 RCC_APB2Periph_SPI3

/* Defines for MOSI pin*/
#define SPIRIT_SPI_PERIPH_MOSI_PORT           GPIOA
#define SPIRIT_SPI_PERIPH_MOSI_PIN            GPIO_Pin_5
#define SPIRIT_SPI_PERIPH_MOSI_AF             GPIO_AF_SPI3
#define SPIRIT_SPI_PERIPH_MOSI_RCC            RCC_AHBPeriph_GPIOB
#define SPIRIT_SPI_PERIPH_MOSI_RCC_SOURCE     GPIO_PinSource5

/* Defines for MISO pin */
#define SPIRIT_SPI_PERIPH_MISO_PORT           GPIOA
#define SPIRIT_SPI_PERIPH_MISO_PIN            GPIO_Pin_4
#define SPIRIT_SPI_PERIPH_MISO_AF             GPIO_AF_SPI3
#define SPIRIT_SPI_PERIPH_MISO_RCC            RCC_AHBPeriph_GPIOB
#define SPIRIT_SPI_PERIPH_MISO_RCC_SOURCE     GPIO_PinSource4

/* Defines for SCLK pin */
#define SPIRIT_SPI_PERIPH_SCLK_PORT           GPIOA
#define SPIRIT_SPI_PERIPH_SCLK_PIN            GPIO_Pin_3
#define SPIRIT_SPI_PERIPH_SCLK_AF             GPIO_AF_SPI3
#define SPIRIT_SPI_PERIPH_SCLK_RCC            RCC_AHBPeriph_GPIOB
#define SPIRIT_SPI_PERIPH_SCLK_RCC_SOURCE     GPIO_PinSource3

/* Defines for chip select pin */
#define SPIRIT_SPI_PERIPH_CS_PORT             GPIOA
#define SPIRIT_SPI_PERIPH_CS_PIN              GPIO_Pin_15
#define SPIRIT_SPI_PERIPH_CS_RCC              RCC_AHBPeriph_GPIOA
#define SPIRIT_SPI_PERIPH_CS_RCC_SOURCE       GPIO_PinSource15  
#endif 
#endif  
