...
typedef enum
{
  ...
  MC_STATE_RX                =0x33,	/*!< RX */
  MC_STATE_TX                =0x5F,	/*!< TX */
  MC_STATE_LOCKWON           =0x13	/*!< Transient state before lock */
  //MC_STATE_LOCK_RX           =0xF0, //Added for ease of commanding this state
  //MC_STATE_LOCK_TX           =0xF1  //Added for ease of commanding this state
} SpiritState;
