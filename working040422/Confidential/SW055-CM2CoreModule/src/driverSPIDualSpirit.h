...
void SpiritSpiInit(uint8_t spiPort);
SpiritStatus SpiritSpiWriteRegisters(uint8_t spiPort, uint8_t cRegAddress, uint8_t cNbBytes, uint8_t* pcBuffer);
SpiritStatus SpiritSpiReadRegisters(uint8_t spiPort, uint8_t cRegAddress, uint8_t cNbBytes, uint8_t* pcBuffer);
SpiritStatus SpiritSpiCommandStrobes(uint8_t spiPort, uint8_t cCommandCode);
SpiritStatus SpiritSpiWriteLinearFifo(uint8_t spiPort, uint8_t cNbBytes, uint8_t* pcBuffer);
SpiritStatus SpiritSpiReadLinearFifo(uint8_t spiPort, uint8_t cNbBytes, uint8_t* pcBuffer);
/**
 * @}
 */
