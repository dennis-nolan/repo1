...
#define STM32F103x_HD  /* STM32F103x_HD, STM32F103x_MD, STM32F103x_LD, STM32F100x_LD, 
...
#define EMERGENCY2_STOP_GPIO_PIN          GPIO_Pin_6
...
/* Hall timer section */
#define HALL_TIMER_SELECTION              HALL_TIM3  /* HALL_TIM2...HALL_TIM5 */ 
#define HALL_TIMER_REMAPPING              FULL_REMAP_TIM3  /* NO_REMAP, FULL_REMAP, 
                                                            PARTIAL_REMAP */
#define H1_GPIO_PORT                      GPIOC
#define H2_GPIO_PORT                      GPIOC
#define H3_GPIO_PORT                      GPIOC

#define H1_GPIO_PIN                       GPIO_Pin_6
#define H2_GPIO_PIN                       GPIO_Pin_7
...
#define PHASE_U_CURR_CHANNEL            ADC_Channel_14
#define PHASE_U_GPIO_PORT               GPIOC
#define PHASE_U_GPIO_PIN                GPIO_Pin_4
#define PHASE_V_CURR_ADC                ADC1_2
#define PHASE_V_CURR_CHANNEL            ADC_Channel_15
#define PHASE_V_GPIO_PORT               GPIOC
#define PHASE_V_GPIO_PIN                GPIO_Pin_5
/* Only for three shunts case */
#define PHASE_W_CURR_ADC                ADC1_2
#define PHASE_W_CURR_CHANNEL            ADC_Channel_15
#define PHASE_W_GPIO_PORT               GPIOC
#define PHASE_W_GPIO_PIN                GPIO_Pin_5       
...
#define TEMP_FDBK_CHANNEL               ADC_Channel_11
...
#define DEFAULT_DAC_CHANNEL_2            MC_PROTOCOL_REG_OBS_EL_ANGLE
...
#define DAC_TIMER_CH1_GPIO_PIN           GPIO_Pin_4
#define DAC_TIMER_CH2_GPIO_PORT          GPIOA
#define DAC_TIMER_CH2_GPIO_PIN           GPIO_Pin_5

#define SW_OV_CURRENT_PROT_ENABLING      DISABLE /*!< Over-current detection 
                                                         enabling */

#define START_STOP_GPIO_PORT             GPIOA
#define START_STOP_GPIO_PIN              GPIO_Pin_3
#define START_STOP_POLARITY              DIN_ACTIVE_HIGH
