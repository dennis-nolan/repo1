...
#ifdef CPU_CLK_48_MHZ
#define TIM_CLOCK_DIVIDER  1
#define ADC_CLOCK_DIVIDER  RCC_ADCCLK_HSI14
#define ADV_TIM_CLK_MHz    48uL/TIM_CLOCK_DIVIDER
#define ADC_CLK_MHz        14uL
#define HALL_TIM_CLK       48000000uL
#else
  #error "Invalid configuration: CPU_CLK definition in Control stage parameters.h not supported"
#endif
...
#elif ((defined(STM32F051x)) || (defined(STM32F050x)) || (defined(STM32F030x)))
...
#define FULL_REMAP_TIM2			GPIO_NoRemap_TIMx
#define PARTIAL_REMAP_01_TIM2		GPIO_NoRemap_TIMx
#define PARTIAL_REMAP_10_TIM2		GPIO_NoRemap_TIMx
#define NO_REMAP_TIM2                   GPIO_NoRemap_TIMx

#define FULL_REMAP_TIM3			GPIO_NoRemap_TIMx
#define PARTIAL_REMAP_TIM3		GPIO_NoRemap_TIMx
#define NO_REMAP_TIM3                   GPIO_NoRemap_TIMx

#define REMAP_TIM4			GPIO_NoRemap_TIMx
...
#define SAMPLING_TIME_NS (((CURR_SAMPLING_TIME) * 2000uL/ADC_CLK_MHz)+(8000uL/(2*ADC_CLK_MHz)))

#if (CURR_SAMPLING_TIME == 1)
#define SAMPLING_TIME_SEL  ADC_SampleTime_1_5Cycles
#elif (CURR_SAMPLING_TIME == 7)
#define SAMPLING_TIME_SEL  ADC_SampleTime_7_5Cycles
#elif (CURR_SAMPLING_TIME == 13)
#define SAMPLING_TIME_SEL  ADC_SampleTime_13_5Cycles
#elif (CURR_SAMPLING_TIME == 28)
#define SAMPLING_TIME_SEL  ADC_SampleTime_28_5Cycles
#endif
...
#define VQD_SW_FILTER_BW_FACTOR       128
...
#define VBUS_SAMPLING_TIME  ADC_SampleTime_1_5Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 7)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_7_5Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 13)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_13_5Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 28)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_28_5Cycles
#else
#define VBUS_SAMPLING_TIME  ADC_SampleTime_1_5Cycles
#endif

#if (TEMP_ADC_SAMPLING_TIME == 1)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_1_5Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 7)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_7_5Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 13)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_13_5Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 28)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_28_5Cycles
#else
#define TEMP_SAMPLING_TIME  ADC_SampleTime_1_5Cycles
#endif
...
#define GPIO_NoRemap_USARTx 0
  ...
  #define USART_GPIO_REMAP      GPIO_NoRemap_USARTx /* Dummy */
#endif
...
#define JOYSTIK_ACTIVE      Bit_SET
#define JOYSTIK_INACTIVE    Bit_RESET
