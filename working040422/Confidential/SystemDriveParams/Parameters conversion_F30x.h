...
#ifndef ADC_CLOCK_WB_DIV
#define ADC_CLOCK_WB_DIV  1
#endif

#if (ADC_CLOCK_WB_DIV == 0)
#undef ADC_CLOCK_WB_DIV
#define ADC_CLOCK_WB_DIV 1
#endif

#if   (ADC_CLOCK_WB_DIV == 1)
#define ADC_CLOCK_DIVIDER  ADC_Clock_SynClkModeDiv1
#elif (ADC_CLOCK_WB_DIV == 2)
#define ADC_CLOCK_DIVIDER  ADC_Clock_SynClkModeDiv2
#elif (ADC_CLOCK_WB_DIV == 4)
#define ADC_CLOCK_DIVIDER  ADC_Clock_SynClkModeDiv4
#endif
...
#define ADC_CLK_MHz        (56uL/ADC_CLOCK_DIV)
#define HALL_TIM_CLK       SYSCLK_FREQ_56MHz
#error "The CPU frequency set in Contol stage parameters is not automatically configured in system_stm32f30x.c. Please configure it manually if you require to work with the selected CPU frequency. Once done, comment this line to avoid to show this messagge again."

#elif defined CPU_CLK_48_MHZ
#define SYSCLK_FREQ_48MHz  48000000uL
#define TIM_CLOCK_DIVIDER  1
#define ADV_TIM_CLK_MHz    (48uL/TIM_CLOCK_DIVIDER)
#define ADC_CLK_MHz        (48uL/ADC_CLOCK_DIV)
...
#define ADC_CLK_MHz        (24uL/ADC_CLOCK_DIV)
#define HALL_TIM_CLK       SYSCLK_FREQ_24MHz
#error "The CPU frequency set in Contol stage parameters is not automatically configured in system_stm32f30x.c. Please configure it manually if you require to work with the selected CPU frequency. Once done, comment this line to avoid to show this messagge again."
#else
#error "Invalid configuration: The CPU frequency set in Contol stage parameters is not supported."
#endif
...
#define FREQ_STARTUP_PWM_STEPS (uint32_t) ((FREQ_START_UP_DURATION * TF_REGULATION_RATE)\
                                                                          /1000u) 
#define FREQ_INC (uint16_t) ((FINAL_START_UP_SPEED*POLE_PAIR_NUM*65536u/60u)\
                                                        /FREQ_STARTUP_PWM_STEPS)
#define I_STARTUP_PWM_STEPS (uint32_t) ((I_START_UP_DURATION * TF_REGULATION_RATE)/1000u) 
#define I_INC (uint16_t)((FINAL_I_STARTUP -FIRST_I_STARTUP)*1024u/I_STARTUP_PWM_STEPS)
...
#if (HIGH_SIDE_IDLE_STATE != TURN_OFF)
#error "Error: HIGH_SIDE_IDLE_STATE in Driver parameters.h must be TURN_OFF."
#endif

#if !defined(HIGH_SIDE_BRAKE_STATE)
#define HIGH_SIDE_BRAKE_STATE TURN_OFF
#endif

#if (HIGH_SIDE_BRAKE_STATE == TURN_OFF)
#if (PHASE_UH_POLARITY == H_ACTIVE_HIGH)
#define BRAKE_UH_POLARITY  TIM_OCIdleState_Reset
#else /* PHASE_UH_POLARITY = H_ACTIVE_LOW */
#define BRAKE_UH_POLARITY  TIM_OCIdleState_Set
#endif
#else /* HIGH_SIDE_BRAKE_STATE = TURN_ON */
#if	(PHASE_UH_POLARITY == H_ACTIVE_HIGH)
#define BRAKE_UH_POLARITY  TIM_OCIdleState_Set
#else /* PHASE_UH_POLARITY = H_ACTIVE_LOW */
#define BRAKE_UH_POLARITY  TIM_OCIdleState_Reset
...
#else /* PHASE_VH_POLARITY = H_ACTIVE_LOW */
#define BRAKE_VH_POLARITY  TIM_OCIdleState_Set
#endif
#else /* HIGH_SIDE_BRAKE_STATE = TURN_ON */
#if	(PHASE_VH_POLARITY == H_ACTIVE_HIGH)
#define BRAKE_VH_POLARITY  TIM_OCIdleState_Set
...
#else /* PHASE_WH_POLARITY = H_ACTIVE_LOW */
#define BRAKE_WH_POLARITY  TIM_OCIdleState_Set
#endif
#else /* HIGH_SIDE_BRAKE_STATE = TURN_ON */
#if	(PHASE_WH_POLARITY == H_ACTIVE_HIGH)
#define BRAKE_WH_POLARITY  TIM_OCIdleState_Set
...
#if (LOW_SIDE_IDLE_STATE != TURN_OFF)
#error "Error: LOW_SIDE_IDLE_STATE in Driver parameters.h must be TURN_OFF."
#endif

#if !defined(LOW_SIDE_BRAKE_STATE)
#define LOW_SIDE_BRAKE_STATE TURN_OFF
#endif

#if (LOW_SIDE_BRAKE_STATE == TURN_OFF)
#if	(PHASE_UL_POLARITY == L_ACTIVE_HIGH)
#define BRAKE_UL_POLARITY  TIM_OCNIdleState_Reset
#else /* PHASE_UL_POLARITY = L_ACTIVE_LOW */
#define BRAKE_UL_POLARITY  TIM_OCNIdleState_Set
#endif
#else /* LOW_SIDE_BRAKE_STATE = TURN_ON */
#if	(PHASE_UL_POLARITY == L_ACTIVE_HIGH)
#define BRAKE_UL_POLARITY  TIM_OCNIdleState_Set
#else /* PHASE_UL_POLARITY = L_ACTIVE_LOW */
#define BRAKE_UL_POLARITY  TIM_OCNIdleState_Reset
...
#else /* PHASE_VL_POLARITY = L_ACTIVE_LOW */
#define BRAKE_VL_POLARITY  TIM_OCNIdleState_Set
#endif
#else /* LOW_SIDE_BRAKE_STATE = TURN_ON */
#if	(PHASE_VL_POLARITY == L_ACTIVE_HIGH)
#define BRAKE_VL_POLARITY  TIM_OCNIdleState_Set
...
#else /* PHASE_WL_POLARITY = L_ACTIVE_LOW */
#define BRAKE_WL_POLARITY  TIM_OCNIdleState_Set
#endif
#else /* LOW_SIDE_BRAKE_STATE = TURN_ON */
#if	(PHASE_WL_POLARITY == L_ACTIVE_HIGH)
#define BRAKE_WL_POLARITY  TIM_OCNIdleState_Set
...
#if (PWM_TIMER_SELECTION == PWM_TIM1)
...
#endif
#if (PWM_TIMER_SELECTION == PWM_TIM8)
#define TIMx_UP_M1_IRQHandler TIM8_UP_IRQHandler
#define TIMx_UP_M1_IRQFlag 1
...
#ifndef OCP_OUTPUT_GPIO_AF
#define OCP_OUTPUT_GPIO_AF GPIO_AF_0
#endif

#ifndef OCPA_OUTPUT_GPIO_AF
#define OCPA_OUTPUT_GPIO_AF GPIO_AF_0
#endif

#ifndef OCPB_OUTPUT_GPIO_AF
#define OCPB_OUTPUT_GPIO_AF GPIO_AF_0
#endif

#ifndef OCPC_OUTPUT_GPIO_AF
#define OCPC_OUTPUT_GPIO_AF GPIO_AF_0
#endif

#ifndef OVP_OUTPUT_GPIO_AF
#define OVP_OUTPUT_GPIO_AF GPIO_AF_0
#endif
...
#elif (CURR_SAMPLING_TIME == 2)
#define SAMPLING_TIME_SEL  ADC_SampleTime_2Cycles5
#elif (CURR_SAMPLING_TIME == 4)
#define SAMPLING_TIME_SEL  ADC_SampleTime_4Cycles5
#elif (CURR_SAMPLING_TIME == 7)
#define SAMPLING_TIME_SEL  ADC_SampleTime_7Cycles5
#elif (CURR_SAMPLING_TIME == 19)
#define SAMPLING_TIME_SEL  ADC_SampleTime_19Cycles5
#elif (CURR_SAMPLING_TIME == 61)
#define SAMPLING_TIME_SEL  ADC_SampleTime_61Cycles5
#elif (CURR_SAMPLING_TIME == 181)
#define SAMPLING_TIME_SEL  ADC_SampleTime_181Cycles5
#elif (CURR_SAMPLING_TIME == 601)
#define SAMPLING_TIME_SEL  ADC_SampleTime_601Cycles5
#endif
...
#elif (VBUS_ADC_SAMPLING_TIME == 2)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_2Cycles5
#elif (VBUS_ADC_SAMPLING_TIME == 4)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_4Cycles5
#elif (VBUS_ADC_SAMPLING_TIME == 7)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_7Cycles5
#elif (VBUS_ADC_SAMPLING_TIME == 19)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_19Cycles5
#elif (VBUS_ADC_SAMPLING_TIME == 61)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_61Cycles5
#elif (VBUS_ADC_SAMPLING_TIME == 181)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_181Cycles5
#elif (VBUS_ADC_SAMPLING_TIME == 601)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_601Cycles5
#else
#define VBUS_SAMPLING_TIME  ADC_SampleTime_1Cycles5
#endif
...
#elif (TEMP_ADC_SAMPLING_TIME == 2)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_2Cycles5
#elif (TEMP_ADC_SAMPLING_TIME == 4)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_4Cycles5
#elif (TEMP_ADC_SAMPLING_TIME == 7)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_7Cycles5
#elif (TEMP_ADC_SAMPLING_TIME == 19)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_19Cycles5
#elif (TEMP_ADC_SAMPLING_TIME == 61)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_61Cycles5
#elif (TEMP_ADC_SAMPLING_TIME == 181)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_181Cycles5
#elif (TEMP_ADC_SAMPLING_TIME == 601)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_601Cycles5
#else
#define TEMP_SAMPLING_TIME  ADC_SampleTime_1Cycles5
#endif
...
#if (defined(SINGLE_SHUNT) || defined(THREE_SHUNT) || defined(THREE_SHUNT_INDEPENDENT_RESOURCES) || defined(THREE_SHUNT_SHARED_RESOURCES))
...
#if (USART_SELECTION == USE_USART4)
  #define USART                   UART4
  #define USART_CLK               RCC_APB1Periph_USART4
  #define USART_IRQ               USART4_IRQn
  #define USART_IRQHandler        USART4_IRQHandler
  /* Dummy */
  #define USART_GPIO_REMAP      GPIO_NoRemap_USARTx
#endif

#if (USART_SELECTION == USE_USART5)
  #define USART                   UART5
  #define USART_CLK               RCC_APB1Periph_USART5
  #define USART_IRQ               USART5_IRQn
  #define USART_IRQHandler        USART5_IRQHandler
  /* Dummy */
  #define USART_GPIO_REMAP      GPIO_NoRemap_USARTx
#endif
...
#define OPAMP1_InvertingInput_PC5       OPAMP_InvertingInput_IO1
#define OPAMP1_InvertingInput_PA3       OPAMP_InvertingInput_IO2
#define OPAMP1_InvertingInput_PGA       OPAMP_InvertingInput_PGA
#define OPAMP1_InvertingInput_FOLLOWER  OPAMP_InvertingInput_Vout
#define OPAMP2_InvertingInput_PC5       OPAMP_InvertingInput_IO1
#define OPAMP2_InvertingInput_PA5       OPAMP_InvertingInput_IO2
#define OPAMP2_InvertingInput_PGA       OPAMP_InvertingInput_PGA
#define OPAMP2_InvertingInput_FOLLOWER  OPAMP_InvertingInput_Vout
#define OPAMP3_InvertingInput_PB10      OPAMP_InvertingInput_IO1
#define OPAMP3_InvertingInput_PB2       OPAMP_InvertingInput_IO2
#define OPAMP3_InvertingInput_PGA       OPAMP_InvertingInput_PGA
#define OPAMP3_InvertingInput_FOLLOWER  OPAMP_InvertingInput_Vout
#define OPAMP4_InvertingInput_PB10      OPAMP_InvertingInput_IO1
#define OPAMP4_InvertingInput_PD8       OPAMP_InvertingInput_IO2
#define OPAMP4_InvertingInput_PGA       OPAMP_InvertingInput_PGA
#define OPAMP4_InvertingInput_FOLLOWER  OPAMP_InvertingInput_Vout

#define OPAMP1_NonInvertingInput_PA7    OPAMP_NonInvertingInput_IO1
#define OPAMP1_NonInvertingInput_PA5    OPAMP_NonInvertingInput_IO2
#define OPAMP1_NonInvertingInput_PA3    OPAMP_NonInvertingInput_IO3
#define OPAMP1_NonInvertingInput_PA1    OPAMP_NonInvertingInput_IO4
#define OPAMP2_NonInvertingInput_PD14   OPAMP_NonInvertingInput_IO1
#define OPAMP2_NonInvertingInput_PB14   OPAMP_NonInvertingInput_IO2
#define OPAMP2_NonInvertingInput_PB0    OPAMP_NonInvertingInput_IO3
#define OPAMP2_NonInvertingInput_PA7    OPAMP_NonInvertingInput_IO4
#define OPAMP3_NonInvertingInput_PB13   OPAMP_NonInvertingInput_IO1
#define OPAMP3_NonInvertingInput_PA5    OPAMP_NonInvertingInput_IO2
#define OPAMP3_NonInvertingInput_PA1    OPAMP_NonInvertingInput_IO3
#define OPAMP3_NonInvertingInput_PB0    OPAMP_NonInvertingInput_IO4
#define OPAMP4_NonInvertingInput_PD11   OPAMP_NonInvertingInput_IO1
#define OPAMP4_NonInvertingInput_PB11   OPAMP_NonInvertingInput_IO2
#define OPAMP4_NonInvertingInput_PA4    OPAMP_NonInvertingInput_IO3
#define OPAMP4_NonInvertingInput_PB13   OPAMP_NonInvertingInput_IO4

#define OPAMP1_PGAConnect_PC5  OPAMP_PGAConnect_IO1
#define OPAMP1_PGAConnect_PA3  OPAMP_PGAConnect_IO2
#define OPAMP2_PGAConnect_PC5  OPAMP_PGAConnect_IO1
#define OPAMP2_PGAConnect_PA5  OPAMP_PGAConnect_IO2
#define OPAMP3_PGAConnect_PB10 OPAMP_PGAConnect_IO1
#define OPAMP3_PGAConnect_PB2  OPAMP_PGAConnect_IO2
#define OPAMP4_PGAConnect_PB10 OPAMP_PGAConnect_IO1
#define OPAMP4_PGAConnect_PD8  OPAMP_PGAConnect_IO2

#define COMP1_InvertingInput_PA0    COMP_InvertingInput_IO1
#define COMP2_InvertingInput_PA2    COMP_InvertingInput_IO1
#define COMP3_InvertingInput_PD15   COMP_InvertingInput_IO1
#define COMP3_InvertingInput_PB12   COMP_InvertingInput_IO2
#define COMP4_InvertingInput_PE8    COMP_InvertingInput_IO1
#define COMP4_InvertingInput_PB2    COMP_InvertingInput_IO2
#define COMP5_InvertingInput_PD13   COMP_InvertingInput_IO1
#define COMP5_InvertingInput_PB10   COMP_InvertingInput_IO2
#define COMP6_InvertingInput_PD10   COMP_InvertingInput_IO1
#define COMP6_InvertingInput_PB15   COMP_InvertingInput_IO2
#define COMP7_InvertingInput_PC0    COMP_InvertingInput_IO1

#define COMPX_InvertingInput_DAC1      COMP_InvertingInput_DAC1OUT1
#define COMPX_InvertingInput_DAC2      COMP_InvertingInput_DAC1OUT2
#define COMPX_InvertingInput_VREF      COMP_InvertingInput_VREFINT
#define COMPX_InvertingInput_VREF_1_4  COMP_InvertingInput_1_4VREFINT
#define COMPX_InvertingInput_VREF_1_2  COMP_InvertingInput_1_2VREFINT
#define COMPX_InvertingInput_VREF_3_4  COMP_InvertingInput_3_4VREFINT

#define COMP1_NonInvertingInput_PA1   COMP_NonInvertingInput_IO1
#define COMP2_NonInvertingInput_PA3   COMP_NonInvertingInput_IO2
#define COMP2_NonInvertingInput_PA7   COMP_NonInvertingInput_IO1
#define COMP3_NonInvertingInput_PB14  COMP_NonInvertingInput_IO1
#define COMP3_NonInvertingInput_PD14  COMP_NonInvertingInput_IO2
#define COMP4_NonInvertingInput_PB0   COMP_NonInvertingInput_IO1
#define COMP4_NonInvertingInput_PE7   COMP_NonInvertingInput_IO2
#define COMP5_NonInvertingInput_PB13  COMP_NonInvertingInput_IO2
#define COMP5_NonInvertingInput_PD12  COMP_NonInvertingInput_IO1
#define COMP6_NonInvertingInput_PB11  COMP_NonInvertingInput_IO2
#define COMP6_NonInvertingInput_PD11  COMP_NonInvertingInput_IO1
#define COMP7_NonInvertingInput_PC1   COMP_NonInvertingInput_IO2
#define COMP7_NonInvertingInput_PA0   COMP_NonInvertingInput_IO1

#if (USE_INTERNAL_OPAMP == ENABLE)
#define R3_4_OPAMPPARAMSM1 &R3_4_F30XOPAMPParamsM1
#define R3_2_OPAMPPARAMSM1 &R3_2_F30XOPAMPParamsM1
#define R1_OPAMPPARAMSM1   &R1_F30XOPAMPParamsM1
#else
#define R3_4_OPAMPPARAMSM1 MC_NULL
#define R3_2_OPAMPPARAMSM1 MC_NULL
#define R1_OPAMPPARAMSM1   MC_NULL
#endif

#if (INTERNAL_OVERCURRENTPROTECTION == ENABLE)
#define OCPA_COMPPARAMSM1 &R3_F30XOCPACOMPParamsM1
#define OCPB_COMPPARAMSM1 &R3_F30XOCPBCOMPParamsM1
#define OCPC_COMPPARAMSM1 &R3_F30XOCPCCOMPParamsM1
#define OCP_COMPPARAMSM1  &R1_F30XOCPCOMPParamsM1
#else
#define OCPA_COMPPARAMSM1 MC_NULL
#define OCPB_COMPPARAMSM1 MC_NULL
#define OCPC_COMPPARAMSM1 MC_NULL
#define OCP_COMPPARAMSM1  MC_NULL
#endif

#if (INTERNAL_OVERVOLTAGEPROTECTION == ENABLE)
#define OVP_COMPPARAMSM1 &F30XOVPCOMPParamsM1
#else
#define OVP_COMPPARAMSM1 MC_NULL
#endif

#if (defined(DUALDRIVE) && (defined(SINGLE_SHUNT) || defined(THREE_SHUNT_INDEPENDENT_RESOURCES)))
#define ADC1_2_DUALDRIVEFIFOUPDATE TSK_DualDriveFIFOUpdate(Exec_IRQ_Handler(MC_IRQ_PWMNCURRFDBK_1,TIMx_UP_M1_IRQFlag))
#define ADC3_DUALDRIVEFIFOUPDATE TSK_DualDriveFIFOUpdate(Exec_IRQ_Handler(MC_IRQ_PWMNCURRFDBK_2,TIMx_UP_M2_IRQFlag))
#else
...
/* TIM 2 - CH1*/
#if ((H1_GPIO_PORT == GPIOA) && (H1_GPIO_PIN == GPIO_Pin_0))
#define H1_GPIO_AF GPIO_AF_1
#endif
#if ((H1_GPIO_PORT == GPIOA) && (H1_GPIO_PIN == GPIO_Pin_5))
#define H1_GPIO_AF GPIO_AF_1
#endif
#if ((H1_GPIO_PORT == GPIOA) && (H1_GPIO_PIN == GPIO_Pin_15))
#define H1_GPIO_AF GPIO_AF_1
#endif
#if ((H1_GPIO_PORT == GPIOD) && (H1_GPIO_PIN == GPIO_Pin_3))
#define H1_GPIO_AF GPIO_AF_2
#endif

/* TIM 3 - CH1*/
#if ((H1_GPIO_PORT == GPIOA) && (H1_GPIO_PIN == GPIO_Pin_6))
#define H1_GPIO_AF GPIO_AF_2
#endif
#if ((H1_GPIO_PORT == GPIOB) && (H1_GPIO_PIN == GPIO_Pin_4))
#define H1_GPIO_AF GPIO_AF_2
#endif
#if ((H1_GPIO_PORT == GPIOC) && (H1_GPIO_PIN == GPIO_Pin_6))
#define H1_GPIO_AF GPIO_AF_2
#endif
#if ((H1_GPIO_PORT == GPIOE) && (H1_GPIO_PIN == GPIO_Pin_2))
#define H1_GPIO_AF GPIO_AF_2
#endif

/* TIM 4 - CH1*/
#if ((H1_GPIO_PORT == GPIOA) && (H1_GPIO_PIN == GPIO_Pin_11))
#define H1_GPIO_AF GPIO_AF_10
#endif
#if ((H1_GPIO_PORT == GPIOB) && (H1_GPIO_PIN == GPIO_Pin_6))
#define H1_GPIO_AF GPIO_AF_2
#endif
#if ((H1_GPIO_PORT == GPIOD) && (H1_GPIO_PIN == GPIO_Pin_12))
#define H1_GPIO_AF GPIO_AF_2
#endif

/* TIM 2 - CH2*/
#if ((H2_GPIO_PORT == GPIOA) && (H2_GPIO_PIN == GPIO_Pin_1))
#define H2_GPIO_AF GPIO_AF_1
#endif
#if ((H2_GPIO_PORT == GPIOB) && (H2_GPIO_PIN == GPIO_Pin_3))
#define H2_GPIO_AF GPIO_AF_1
#endif
#if ((H2_GPIO_PORT == GPIOD) && (H2_GPIO_PIN == GPIO_Pin_4))
#define H2_GPIO_AF GPIO_AF_2
#endif

/* TIM 3 - CH2*/
#if ((H2_GPIO_PORT == GPIOA) && (H2_GPIO_PIN == GPIO_Pin_4))
#define H2_GPIO_AF GPIO_AF_2
#endif
#if ((H2_GPIO_PORT == GPIOA) && (H2_GPIO_PIN == GPIO_Pin_7))
#define H2_GPIO_AF GPIO_AF_2
#endif
#if ((H2_GPIO_PORT == GPIOB) && (H2_GPIO_PIN == GPIO_Pin_5))
#define H2_GPIO_AF GPIO_AF_2
#endif
#if ((H2_GPIO_PORT == GPIOC) && (H2_GPIO_PIN == GPIO_Pin_7))
#define H2_GPIO_AF GPIO_AF_2
#endif
#if ((H2_GPIO_PORT == GPIOE) && (H2_GPIO_PIN == GPIO_Pin_3))
#define H2_GPIO_AF GPIO_AF_2
#endif

/* TIM 4 - CH2*/
#if ((H2_GPIO_PORT == GPIOA) && (H2_GPIO_PIN == GPIO_Pin_12))
#define H2_GPIO_AF GPIO_AF_10
#endif
#if ((H2_GPIO_PORT == GPIOB) && (H2_GPIO_PIN == GPIO_Pin_7))
#define H2_GPIO_AF GPIO_AF_2
#endif
#if ((H2_GPIO_PORT == GPIOD) && (H2_GPIO_PIN == GPIO_Pin_13))
#define H2_GPIO_AF GPIO_AF_2
#endif

/* TIM 2 - CH3*/
#if ((H3_GPIO_PORT == GPIOA) && (H3_GPIO_PIN == GPIO_Pin_2))
#define H3_GPIO_AF GPIO_AF_1
#endif
#if ((H3_GPIO_PORT == GPIOA) && (H3_GPIO_PIN == GPIO_Pin_9))
#define H3_GPIO_AF GPIO_AF_10
#endif
#if ((H3_GPIO_PORT == GPIOB) && (H3_GPIO_PIN == GPIO_Pin_10))
#define H3_GPIO_AF GPIO_AF_1
#endif
#if ((H3_GPIO_PORT == GPIOD) && (H3_GPIO_PIN == GPIO_Pin_7))
#define H3_GPIO_AF GPIO_AF_2
#endif

/* TIM 3 - CH3*/
#if ((H3_GPIO_PORT == GPIOB) && (H3_GPIO_PIN == GPIO_Pin_0))
#define H3_GPIO_AF GPIO_AF_2
#endif
#if ((H3_GPIO_PORT == GPIOC) && (H3_GPIO_PIN == GPIO_Pin_8))
#define H3_GPIO_AF GPIO_AF_2
#endif
#if ((H3_GPIO_PORT == GPIOE) && (H3_GPIO_PIN == GPIO_Pin_4))
#define H3_GPIO_AF GPIO_AF_2
#endif

/* TIM 4 - CH3*/
#if ((H3_GPIO_PORT == GPIOA) && (H3_GPIO_PIN == GPIO_Pin_13))
#define H3_GPIO_AF GPIO_AF_10
#endif
#if ((H3_GPIO_PORT == GPIOB) && (H3_GPIO_PIN == GPIO_Pin_8))
#define H3_GPIO_AF GPIO_AF_2
#endif
#if ((H3_GPIO_PORT == GPIOD) && (H3_GPIO_PIN == GPIO_Pin_14))
#define H3_GPIO_AF GPIO_AF_2
#endif
