...
#ifndef __PARAMETERS_CONVERSION_F4XX_MOTOR2_H
#define __PARAMETERS_CONVERSION_F4XX_MOTOR2_H
...
#ifdef CPU_CLK_150_MHZ
#define ADC_CLOCK_DIVIDER2  ADC_Prescaler_Div4
#define TIM_CLOCK_DIVIDER2  2
#define ADV_TIM_CLK_MHz2    150uL/TIM_CLOCK_DIVIDER2
#define ADC_CLK_MHz2        19uL // 18.75MHz
#define HALL_TIM_CLK2       75000000uL

#elif defined CPU_CLK_168_MHZ
#define ADC_CLOCK_DIVIDER2  ADC_Prescaler_Div4
#define TIM_CLOCK_DIVIDER2  2
#define ADV_TIM_CLK_MHz2    168uL/TIM_CLOCK_DIVIDER
#define ADC_CLK_MHz2        21uL // 21MHz
#define HALL_TIM_CLK2       84000000uL
#elif defined CPU_CLK_120_MHZ
#define ADC_CLOCK_DIVIDER2  ADC_Prescaler_Div2
#define TIM_CLOCK_DIVIDER2  2
#define ADV_TIM_CLK_MHz2    120uL/TIM_CLOCK_DIVIDER
#define ADC_CLK_MHz2        30uL // 30MHz
#define HALL_TIM_CLK2       60000000uL
#else
  #warning "CPU_CLK different from 150MHz to be implemented"
#endif
...
#define FREQ_STARTUP_PWM_STEPS2 (uint32_t) ((FREQ_START_UP_DURATION2 * TF_REGULATION_RATE2)\
                                                                          /1000u) 
#define FREQ_INC2 (uint16_t) ((FINAL_START_UP_SPEED2*POLE_PAIR_NUM2*65536u/60u)\
                                                        /FREQ_STARTUP_PWM_STEPS2)
#define I_STARTUP_PWM_STEPS2 (uint32_t) ((I_START_UP_DURATION2 * TF_REGULATION_RATE2)/1000u) 
#define I_INC2 (uint16_t)((FINAL_I_STARTUP2 -FIRST_I_STARTUP2)*1024u/I_STARTUP_PWM_STEPS2)
...
#define DMAx_R1_M2_Flag       DMA_FLAG_TCIF4
#endif
...
#define DMAx_R1_M2_Flag       DMA_FLAG_TCIF7
#endif
#undef PWM_TIM1
#undef PWM_TIM8
...
#if ((LOW_SIDE_SIGNALS_ENABLING2 == ENABLE)||(LOW_SIDE_SIGNALS_ENABLING2 == LS_PWM_TIMER))
...
#if (CURR_SAMPLING_TIME2 == 3)
#define SAMPLING_TIME_SEL2 ADC_SampleTime_3Cycles  
#elif (CURR_SAMPLING_TIME2 == 15)
#define SAMPLING_TIME_SEL2  ADC_SampleTime_15Cycles
#elif (CURR_SAMPLING_TIME2 == 28)
#define SAMPLING_TIME_SEL2  ADC_SampleTime_28Cycles
#elif (CURR_SAMPLING_TIME2 == 56)
#define SAMPLING_TIME_SEL2  ADC_SampleTime_56Cycles
#elif (CURR_SAMPLING_TIME2 == 84)
#define SAMPLING_TIME_SEL2  ADC_SampleTime_84Cycles
#elif (CURR_SAMPLING_TIME2 == 112)
#define SAMPLING_TIME_SEL2  ADC_SampleTime_112Cycles
#elif (CURR_SAMPLING_TIME2 == 144)
#define SAMPLING_TIME_SEL2  ADC_SampleTime_144Cycles
#elif (CURR_SAMPLING_TIME2 == 480)
#define SAMPLING_TIME_SEL2  ADC_SampleTime_480Cycles
#else
#if defined(DUALDRIVE)
#warning "CURR_SAMPLING_TIME2 not allowed"
#endif
#endif
...
/* Sampling time allowed for F4XX are: 3, 15, 28, 56, 84, 112, 144, 480 ADC clock cycle */    
#if (VBUS_ADC_SAMPLING_TIME2 == 3)
#define VBUS_SAMPLING_TIME2 ADC_SampleTime_3Cycles  
#elif (VBUS_ADC_SAMPLING_TIME2 == 15)
#define VBUS_SAMPLING_TIME2  ADC_SampleTime_15Cycles
#elif (VBUS_ADC_SAMPLING_TIME2 == 28)
#define VBUS_SAMPLING_TIME2  ADC_SampleTime_28Cycles
#elif (VBUS_ADC_SAMPLING_TIME2 == 56)
#define VBUS_SAMPLING_TIME2  ADC_SampleTime_56Cycles
#elif (VBUS_ADC_SAMPLING_TIME2 == 84)
#define VBUS_SAMPLING_TIME2  ADC_SampleTime_84Cycles
#elif (VBUS_ADC_SAMPLING_TIME2 == 112)
#define VBUS_SAMPLING_TIME2  ADC_SampleTime_112Cycles
#elif (VBUS_ADC_SAMPLING_TIME2 == 144)
#define VBUS_SAMPLING_TIME2  ADC_SampleTime_144Cycles
#elif (VBUS_ADC_SAMPLING_TIME2 == 480)
#define VBUS_SAMPLING_TIME2  ADC_SampleTime_480Cycles
#else
#define VBUS_SAMPLING_TIME2 ADC_SampleTime_3Cycles
#endif

/* Sampling time allowed for F4XX are: 3, 15, 28, 56, 84, 112, 144, 480 ADC clock cycle */    
#if (TEMP_ADC_SAMPLING_TIME2 == 3)
#define TEMP_SAMPLING_TIME2 ADC_SampleTime_3Cycles  
#elif (TEMP_ADC_SAMPLING_TIME2 == 15)
#define TEMP_SAMPLING_TIME2  ADC_SampleTime_15Cycles
#elif (TEMP_ADC_SAMPLING_TIME2 == 28)
#define TEMP_SAMPLING_TIME2  ADC_SampleTime_28Cycles
#elif (TEMP_ADC_SAMPLING_TIME2 == 56)
#define TEMP_SAMPLING_TIME2  ADC_SampleTime_56Cycles
#elif (TEMP_ADC_SAMPLING_TIME2 == 84)
#define TEMP_SAMPLING_TIME2  ADC_SampleTime_84Cycles
#elif (TEMP_ADC_SAMPLING_TIME2 == 112)
#define TEMP_SAMPLING_TIME2  ADC_SampleTime_112Cycles
#elif (TEMP_ADC_SAMPLING_TIME2 == 144)
#define TEMP_SAMPLING_TIME2  ADC_SampleTime_144Cycles
#elif (TEMP_ADC_SAMPLING_TIME2 == 480)
#define TEMP_SAMPLING_TIME2  ADC_SampleTime_480Cycles
#else
#define TEMP_SAMPLING_TIME2 ADC_SampleTime_3Cycles
#endif
...
#endif /*__PARAMETERS_CONVERSION_F4XX_MOTOR2_H*/
