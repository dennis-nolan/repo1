/**
  ******************************************************************************
  * @file    Parameters conversion_F4XX.h
...
#ifdef CPU_CLK_168_MHZ
#define ADC_CLOCK_DIVIDER  ADC_Prescaler_Div4
#define TIM_CLOCK_DIVIDER  2
#define ADV_TIM_CLK_MHz    168uL/TIM_CLOCK_DIVIDER
#define ADC_CLK_MHz        21uL // 21MHz
#define HALL_TIM_CLK       84000000uL
#else
  #error "CPU_CLK different from 168MHz to be implemented"
#endif

#if defined(EXT_CLK_8_MHZ)
  #define HSE_VALUE            ((uint32_t)8000000) /*!< Value of the External oscillator in Hz */
#elif defined(EXT_CLK_16_MHZ)
  #define HSE_VALUE            ((uint32_t)16000000) /*!< Value of the External oscillator in Hz */
#elif defined(EXT_CLK_25_MHZ)
  #define HSE_VALUE            ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */
#else
  #warning "Only 8Mhz, 16MHz and 25Mhz ext. frequency is supported!"
#endif
