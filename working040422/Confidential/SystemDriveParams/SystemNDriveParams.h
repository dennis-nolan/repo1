...
PWMnCurrFdbkParams_t PWMnCurrFdbkParamsM2 = 
{
  ...
  OFFCALIBRWAITTICKS2,             /*!< Wait time duration before current reading
                                       ...
                                       CRC_EXEC */
  DTCOMPCNT2,                      /*!< It contains half of Dead time expressed
                                       in timer clock cycles unit:
...
RevupCtrlParams_t RevupCtrlParamsM2 =
{
 ...
 (int16_t)((int32_t)(STARTING_ANGLE_DEG2)* 65536/360),    /*!< Starting angle of programmed rev up.*/
  &Phase1_M2,                /*!< Pointer of the first element of 
                                     ...
                                     RUCPhasesParams_t.*/
  FIRST_SLESS_ALGO_PHASE2,   /*< Indicate here in which of the rev-up phases
  ...
  OBS_MINIMUM_SPEED2,                 /*!< Minimum mechanical speed (expressed in
                                      01Hz required to validate the start-up */
  (int16_t)((OBS_MINIMUM_SPEED2)/2),    /*!< Minimum mechanical speed (expressed in
                                      01Hz required to validate the on the fly*/
  NB_CONSECUTIVE_TESTS2,          /*!< Minimum number of consecutive times the observer
                                       is reliable to validate OTF startup*/
  (int16_t)PHASE5_FINAL_CURRENT2, /*!< Final revup current */
  (uint16_t) 500,                 /*!< On-the-fly section1 duration, millisecond */
  OTF_STARTUP_EN2                 /*!< ENABLE for OTF strartup otherwise FALSE.*/
};
...
{
  TF_REGULATION_RATE2 /*!< Execution frequency expressed in Hz */
};
...
PWMnCurrFdbkParams_t PWMnCurrFdbkParamsM1 = 
{
  ...
  OFFCALIBRWAITTICKS,              /*!< Wait time duration before current reading
                                       ...
                                       of PWMC_CurrentReadingCalibr with action
                                       CRC_EXEC */
  DTCOMPCNT,                        /*!< It contains half of Dead time expressed
                                       in timer clock cycles unit:
                                       hDTCompCnt = (DT(s) * Timer Fclk)/2 */
  TON,                              /*!< Reserved */
  TOFF                              /*!< Reserved */
...
RevupCtrlParams_t RevupCtrlParamsM1 =
{
  ...
  &Phase1_M1,                /*!< Pointer of the first element of 
                                     ...
                                     rev up. Each element is of type 
                                     RUCPhasesParams_t.*/
  FIRST_SLESS_ALGO_PHASE,    /*< Indicate here in which of the rev-up phases
                                     the final acceleration is started. The 
                                     sensor-less algorithm is re-initialized 
                                     (cleared) when this phase begins. 
                               NOTE: The rev up phases counting starts from 0.
  ...
  OBS_MINIMUM_SPEED,                  /*!< Minimum mechanical speed (expressed in 
                                      01Hz required to validate the start-up */
  (int16_t)(OBS_MINIMUM_SPEED/2),     /*!< Minimum mechanical speed (expressed in 
                                      01Hz required to validate the on the fly*/
  NB_CONSECUTIVE_TESTS,          /*!< Minimum number of consecutive times the observer
                                      is reliable to validate OTF startup*/
  (int16_t)PHASE5_FINAL_CURRENT, /*!<  final revup current */
  (uint16_t) 500,                /*!<  on-the-fly section1 duration, millisecond */
  OTF_STARTUP_EN                 /*!< ENABLE for OTF strartup otherwise FALSE.*/  
};
...
SelfComCtrlParams_t SelfComCtrlParamsM1 =
{
  ...
  MP_RAMP_DURATION   /*!< Startup ramp duration.*/
};
