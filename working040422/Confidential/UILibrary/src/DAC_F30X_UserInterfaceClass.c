/**
  ******************************************************************************
  * @file    DAC_F30X_UserInterfaceClass.c
  * @author  STMicroelectronics - System Lab - MC Team
  * @version 4.2.0
  * @date    20-Aug-2015 18:06
  * @brief   This file contains private impelementation of DAC class for F3XX      
  ******************************************************************************
  * @attention
  *
...
#include "DAC_F30X_UserInterfacePrivate.h"

#define DCLASS_PARAMS ((_DCDAC_UI)(((_CUI) this)->DerivedClass))->pDParams_str
#define DCLASS_VARS   ((_DCDAC_UI)(((_CUI) this)->DerivedClass))->DVars_str
...
/**
  * @brief  Creates an object of the class DAC for STM32F30x
  ...
  * @retval CDAC_F30X_UI new instance of DAC object
  */
CDAC_UI DAC_F30X_NewObject(pUserInterfaceParams_t pUserInterfaceParams, pDAC_F30XParams_t pDACParams)
{
...
{  
  ...
  if(pDParams_str->hDAC_CH1_ENABLED == ENABLE)
  {
    /* Enable DAC Channel1 */
    ...
    /* GPIOA Configuration: PA4 Channel Output */
  ...
  if(pDParams_str->hDAC_CH2_ENABLED == ENABLE)
  {
    /* Enable DAC Channel2 */
    ...
    /* Configure DAC Output Pin */
    GPIO_StructInit(&GPIO_InitStructure);
    /* GPIOA Configuration: PA5 Channel Output */
...
static void DAC_Exec(CUI this)
{
  ...
  if(pDParams_str->hDAC_CH1_ENABLED == ENABLE)
  {
    ...
    DAC_SetChannel1Data(DAC1, DAC_Align_12b_L,
  ...
  if(pDParams_str->hDAC_CH2_ENABLED == ENABLE)
  {
    ...
    DAC_SetChannel2Data(DAC1, DAC_Align_12b_L,
