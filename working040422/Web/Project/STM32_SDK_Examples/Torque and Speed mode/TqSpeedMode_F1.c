...
uint16_t torque_value = 1800;       //Set the first value for the speed ramp 
uint16_t torque_duration = 100;   //Set the duration for first ramp  
uint16_t speed_threshold = 1800;      //Set the second value for the speed ramp 
uint16_t speed_target = 3000;      //Set the second value for the speed ramp 
