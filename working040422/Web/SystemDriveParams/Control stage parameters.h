...
#define PHASE_W_CURR_CHANNEL            ADC_Channel_6
#define PHASE_W_GPIO_PORT               GPIOC
#define PHASE_W_GPIO_PIN                GPIO_Pin_0       
...
#define VBUS_ADC_SAMPLING_TIME          61

#define TEMP_FDBK_ADC                   ADC1
#define TEMP_FDBK_CHANNEL               ADC_Channel_8
#define TEMP_FDBK_GPIO_PORT             GPIOC
#define TEMP_FDBK_GPIO_PIN              GPIO_Pin_2
