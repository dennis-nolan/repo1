...
#ifndef __PARAMETERS_CONVERSION_F2XX_H
#define __PARAMETERS_CONVERSION_F2XX_H
...
#ifdef CPU_CLK_120_MHZ
#define ADC_CLOCK_DIVIDER  ADC_Prescaler_Div2
#define TIM_CLOCK_DIVIDER  2
#define ADV_TIM_CLK_MHz    120uL/TIM_CLOCK_DIVIDER
#define ADC_CLK_MHz        30uL // 30MHz
#define HALL_TIM_CLK       60000000uL
#else
  #warning "CPU_CLK different from 120MHz to be implemented"
#endif

#if defined(EXT_CLK_8_MHZ)
  #error "The HSE frequency set in Contol stage parameters is not automatically configured in system_stm32f2xx.c. Please configure it manually if you require to work with the selected CPU frequency. Once done, comment this line to avoid to show this messagge again."
#elif defined(EXT_CLK_25_MHZ)
  #define HSE_VALUE            ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */
#else
  #warning "Only 8Mhz and 25Mhz ext. frequency is supported!"
#endif
...
#define DMAx_R1_M1_Flag       DMA_FLAG_TCIF4
#endif
...
#define DMAx_R1_M1_Flag       DMA_FLAG_TCIF7
#endif
#undef PWM_TIM1
#undef PWM_TIM8
...
#else
/* The above definition are done in Parameter conversion motor2 */
#endif

#undef  PWM_TIMER_REMAPPING
#define PWM_TIMER_REMAPPING PWM_NO_REMAP

/**********  AUXILIARY TIMER (SINGLE SHUNT) *************/
/* Defined here for legacy purpouses */
...
#define FULL_REMAP_TIM2			0 /* Dummy */
#define PARTIAL_REMAP_01_TIM2		0 /* Dummy */
#define PARTIAL_REMAP_10_TIM2		0 /* Dummy */
#define NO_REMAP_TIM2                   GPIO_NoRemap_TIMx

#define FULL_REMAP_TIM3			0 /* Dummy */
#define PARTIAL_REMAP_TIM3		0 /* Dummy */
#define NO_REMAP_TIM3                   GPIO_NoRemap_TIMx

#define REMAP_TIM4			0 /* Dummy */
...
/* Sampling time allowed for F2xx are: 3, 15, 28, 56, 84, 112, 144, 480 ADC clock cycle */    
#if (CURR_SAMPLING_TIME == 3)
#define SAMPLING_TIME_SEL ADC_SampleTime_3Cycles  
#elif (CURR_SAMPLING_TIME == 15)
#define SAMPLING_TIME_SEL  ADC_SampleTime_15Cycles
#elif (CURR_SAMPLING_TIME == 28)
#define SAMPLING_TIME_SEL  ADC_SampleTime_28Cycles
#elif (CURR_SAMPLING_TIME == 56)
#define SAMPLING_TIME_SEL  ADC_SampleTime_56Cycles
#elif (CURR_SAMPLING_TIME == 84)
#define SAMPLING_TIME_SEL  ADC_SampleTime_84Cycles
#elif (CURR_SAMPLING_TIME == 112)
#define SAMPLING_TIME_SEL  ADC_SampleTime_112Cycles
#elif (CURR_SAMPLING_TIME == 144)
#define SAMPLING_TIME_SEL  ADC_SampleTime_144Cycles
#elif (CURR_SAMPLING_TIME == 480)
#define SAMPLING_TIME_SEL  ADC_SampleTime_480Cycles
#else
#warning "CURR_SAMPLING_TIME not allowed. Sampling time allowed for F2xx\
 are: 3, 15, 28, 56, 84, 112, 144, 480 ADC clock cycle"
#endif
...
/* Sampling time allowed for F2xx are: 3, 15, 28, 56, 84, 112, 144, 480 ADC clock cycle */    
#if (VBUS_ADC_SAMPLING_TIME == 3)
#define VBUS_SAMPLING_TIME ADC_SampleTime_3Cycles  
#elif (VBUS_ADC_SAMPLING_TIME == 15)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_15Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 28)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_28Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 56)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_56Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 84)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_84Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 112)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_112Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 144)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_144Cycles
#elif (VBUS_ADC_SAMPLING_TIME == 480)
#define VBUS_SAMPLING_TIME  ADC_SampleTime_480Cycles
#else
#define VBUS_SAMPLING_TIME ADC_SampleTime_3Cycles
#endif

/* Sampling time allowed for F2xx are: 3, 15, 28, 56, 84, 112, 144, 480 ADC clock cycle */    
#if (TEMP_ADC_SAMPLING_TIME == 3)
#define TEMP_SAMPLING_TIME ADC_SampleTime_3Cycles  
#elif (TEMP_ADC_SAMPLING_TIME == 15)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_15Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 28)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_28Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 56)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_56Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 84)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_84Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 112)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_112Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 144)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_144Cycles
#elif (TEMP_ADC_SAMPLING_TIME == 480)
#define TEMP_SAMPLING_TIME  ADC_SampleTime_480Cycles
#else
#define TEMP_SAMPLING_TIME ADC_SampleTime_3Cycles
#endif
...
#endif /*__PARAMETERS_CONVERSION_F2XX_H*/
